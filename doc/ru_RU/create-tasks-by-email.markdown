Создание задач через email[¶](#create-tasks-by-email "Ссылка на этот заголовок")
...
©2016, Kanboard.ru. | Powered by [Sphinx 1.3.3](http://sphinx-doc.org/) & [Alabaster 0.7.8](https://github.com/bitprophet/alabaster) | [Page source](_sources/create-tasks-by-email.txt)
