...
Hub <https://registry.hub.docker.com/u/kanboard/kanboard/>`__.
...
The tag **latest** is the **development version** of Kanboard, use at
your own risk.
...
in `official Docker
documentation <https://docs.docker.com/engine/userguide/containers/dockervolumes/>`__.
...
The list of environment variables is available on `this
page <env.markdown>`__.
...
-  `Official Kanboard
   images <https://registry.hub.docker.com/u/kanboard/kanboard/>`__
-  `Docker documentation <https://docs.docker.com/>`__
-  `Dockerfile stable version <https://github.com/kanboard/docker>`__
-  `Dockerfile dev
   version <https://github.com/fguillot/kanboard/blob/master/Dockerfile>`__
