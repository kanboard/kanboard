...
.. figure:: https://kanboard.net/screenshots/documentation/task-creation-board.png
   :alt: Task creation from the board

   Task creation from the board
Then the task creation form appears:

.. figure:: https://kanboard.net/screenshots/documentation/task-creation-form.png
...
-  **Title**: The title of your task, which will be displayed on the
   board.
-  **Description**: Allow you to add more information about the task,
   the content can be written in
   `Markdown <https://kanboard.net/documentation/syntax-guide>`__.
