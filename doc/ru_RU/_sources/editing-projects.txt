...
.. figure:: screenshots/project-edition.png
   :alt: Project edition

   Project edition

-  The start date and end date are used to generate the project Gantt
   chart
-  The description is visible as tooltip on the board and on the
   projects listing page
-  Administrators and project administrators can convert a private
   project to multiple users project by changing the checkbox "Private
   project".
...
have access to the project. Adjust the list of users according to your
needs.
