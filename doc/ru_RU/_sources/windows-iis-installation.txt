...
Go the IIS document root ``C:\inetpub\wwwroot`` and create a file
``phpinfo.php``:
...
Open a browser at ``http://localhost/phpinfo.php`` and you should see
the current PHP settings. If you got an error 500, something is not
correctly done in your installation.
