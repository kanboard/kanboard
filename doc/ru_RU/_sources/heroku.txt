...
-  The storage of Heroku is ephemeral, that means uploaded files through
   ...
   S3 <https://github.com/kanboard/plugin-s3>`__.
-  Some features of Kanboard require that you run `a daily background
   job <cronjob.markdown>`__.

.. |Deploy| image:: https://www.herokucdn.com/deploy/button.png
   :target: https://heroku.com/deploy?template=https://github.com/fguillot/kanboard
