API Procedimientos especificos de usuario
============================

## getMe

- Propósito: **Obtiene la sesión de usuario registrado**
- Parametros: Ninguno
- Resultado en caso exitoso: **user session data**
...
- Propósito: **Obtiene el tablero sin paginación del usuario que inicio sesión**
- Parametros: Ninguno
- Resultado en caso exitoso: **Dashboard information**
- Resultado en caso fallido: **false**
...
- Propósito: **Obtiene los últimos 100 eventos para el usuario que inicio sesión**
- Parametros: Ninguno
...
- Propósito: **Crea un proyecto privado para el usuario que inicio sesión**
- Parametros:
...
- Propósito: **Obtiene proyectos del usuario conectado**
- Parametros: Ninguno
- Resultado en caso exitoso: **dictionary of project_id => project_name**
- Resultado en caso fallido: **false**
...
- Propósito: **Obtiene mis tareas retrasadas**
...
- Propósito: **Obtiene proyectos del usuario conectado con todos los detalles**
- Parametros:
    - **Ninguno**
- Resultado en caso exitoso: **List of projects with details**
- Resultado en caso fallido: **false**
