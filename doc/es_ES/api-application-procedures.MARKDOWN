...
- Propósito: **Obtiene la sesión del usuario registrado**
- Parametros: Ninguno
...
- Propósito: **Obtiene el tablero sin paginación del usuario registrado**
- Parametros: Ninguno
...
- Propósito: **Obtiene los ultimos 100 eventos del usuario registrado**
- Parametros: Ninguno
...
- Propósito: **Crea un proyecto privado para el usuario registrado**
- Parametros:
...
- Propósito: **Obtiene los proyectos del usuario conectado**
- Parametros: Ninguno
...
- Propósito: **Obtiene mis tareas atrasadas**
- Resultado en caso exitoso: **List of tasks**
- Resultado en caso fallido: **false**

Ejemplo de solicitud to fetch all tasks on the board:
...
- Propósito: **Obtiene los proyectos del usuario conectado con todos los detalles**
- Parametros:
    - **Ninguno**
