...
function toggleViewMode(){var str=textarea.value;str=str.replace(/(?:\r\n|\r|\n)/g,'<br>\n');KB.dom(previewElement).html(marked(DOMPurify.sanitize(str)));KB.dom(viewModeElement).toggle();KB.dom(writeModeElement).toggle()}
