...
return array(
    ...
    'Leave a description' => 'Pozostaw opis',
    ...
    'Filter by user' => 'Filtr przez uzytkownika ',
    'Filter by due date' =>'Filtr wedlug terminu ',
    'Everybody' => 'Wszyscy' ,
    'Open' => 'Otwórz' ,
    'Closed' => 'Zamkniety' ,
    'Search' => 'Szukaj' ,
    ...
    'Due date' => 'Termin ',
    'Others formats accepted: %s and %s' => 'Inne formaty akceptowane: %s i %s',
    'Description' => 'Opis' ,
    '%d comments' => '% D komentarzy' ,
    '%d comment' => '% D komentarz' ,
    'Email address invalid' => 'Nieprawidlowy adres e-mail ',
    'Your Google Account is not linked anymore to your profile.' => 'Twoje konto Google nie jest juz polaczony do swojego profilu.',
    'Unable to unlink your Google Account.' => 'Nie mozna odlaczyc konto Google. ',
    'Google authentication failed' => 'Uwierzytelniania Google nie powiodlo sie' ,
    'Unable to link your Google Account.' => 'Nie mozna polaczyc swoje konto Google. ',
    'Your Google Account is linked to your profile successfully.' => 'Twoje konto Google jest powiazane z Twoim profilu pomyslnie. ',
    'Email' => 'E-mail' ,
    'Link my Google Account' => 'Polaczyc konto Google' ,
    'Unlink my Google Account' => 'Usun powiazanie konta Google ',
    'Login with my Google Account' => 'Sie z moim kontem Google ',
    'Project not found.' => 'Projekt nie zostal znaleziony.' ,
    'Task #%d' => 'Zadanie #%d' ,
    'Task removed successfully.' => 'Zadanie usuniete pomyslnie.' ,
    'Unable to remove this task.' => 'Nie mozna usunac tego zadania. ',
    'Remove a task' => 'Usun zadanie ',
    'Do you really want to remove this task: "%s"?' => 'Czy na pewno chcesz usunac to zadanie: "%s"',
    'Assign automatically a color based on a category' => 'Przypisz automatycznie kolor na podstawie kategorii ',
    'Assign automatically a category based on a color' => 'Przypisz automatycznie kategorie na podstawie koloru ',
    'Task creation or modification' => 'Tworzenie zadan lub zmiany ',
    'Category' => 'Kategoria' ,
    'Category:' => 'Kategoria:' ,
    'Categories' => 'Kategorie' ,
    'Category not found.' => 'Nie znaleziono kategorii.' ,
    'Your category have been created successfully.' => 'Twoja kategoria zostala pomyslnie utworzona.' ,
    'Unable to create your category.' => 'Nie mozna utworzyc kategorii.',
    'Your category have been updated successfully.' => 'Kategorii zostaly pomyslnie zaktualizowane.' ,
    'Unable to update your category.' => 'Nie mozna zaktualizowac swoja kategorie.',
    'Remove a category' => 'Usun kategorie ',
    'Category removed successfully.' => 'Kategoria usunieta pomyslnie. ',
    'Unable to remove this category.' => 'Nie mozna usunac te kategorie.',
    'Category modification for the project "%s"' => 'Zmiana kategorii projektu "%s"',
    'Category Name' => 'Nazwa kategorii' ,
    'Categories for the project "%s"' => 'Kategorie dla projektu "%s"',
    'Add a new category' => 'Dodaj nowa kategorie ',
    'Do you really want to remove this category: "%s"?' => 'Czy na pewno chcesz usunac te kategorie: "%s"',
    'Filter by category' => 'Filtr wedlug kategorii ',
    'All categories' => 'Wszystkie kategorie' ,
    'No category' => 'Bez kategorii' ,
    'The name is required' => 'Nazwa jest wymagane ',
    'Remove a file' => 'Usun pliki ',
    'Unable to remove this file.' => 'Nie mozna usunac tego pliku. ',
    'File removed successfully.' => 'Plik usuniety pomyslnie. ',
    'Attach a document' => 'Dolacz dokument' ,
    'Do you really want to remove this file: "%s"?' => 'Czy na pewno chcesz usunac ten plik? "%s"',
    'open' => 'Open' ,
    'Attachments' => 'Zalaczniki' ,
    'Edit the task' => 'Edycja zadania ',
    'Edit the description' => 'Edytuj opis ',
    'Add a comment' => 'Dodaj komentarz' ,
    'Edit a comment' => 'Edytuj komentarz ',
    'Summary' => 'Podsumowanie' ,
    'Time tracking' => 'Sledzenia Czas' ,
    'Estimate:' => 'Szacunek: ',
    'Spent:' => 'Spedzony: ',
    'Do you really want to remove this sub-task?' => 'Czy na pewno chcesz usunac ten pod-zadania?',
    'Remaining:' => 'Pozostalo: ',
    'hours' => 'Godzin' ,
    'spent' => 'Wypalone ',
    'estimated' => 'Szacuje ',
    'Sub-Tasks' => 'Sub-Zadania ',
    'Add a sub-task' => 'Dodaj podzadania' ,
    'Original Estimate' => 'Pierwotnych szacunków' ,
    'Create another sub-task' => 'Utwórz kolejny pod-zadania ',
    'Time Spent' => 'Czas spedzony ',
    'Edit a sub-task' => 'Edycja podzadania ',
    'Remove a sub-task' => 'Usun zadanie podrzedne ',
    ...
    'Unable to update your sub-task.' => 'Nie mozna uaktualnic sub-zadanie. ',
    'Unable to create your sub-task.' => 'Nie mozna utworzyc pod-zadania. ',
    'Sub-task added successfully.' => 'Sub-zadanie pomyslnie dodana. ',
    'Maximum size: ' => 'Maksymalny rozmiar:' ,
    'Unable to upload the file.' => 'Nie udalo sie zaladowac plik. ',
    'Display another project' => 'Pokaz inny projekt' ,
    'Your GitHub account was successfully linked to your profile.' => 'Twoje konto zostalo pomyslnie polaczone GitHub do swojego profilu.',
    'Unable to link your GitHub Account.' => 'Nie mozna polaczyc konto GitHub.',
    'GitHub authentication failed' => 'Uwierzytelnianie GitHub failed' ,
    'Your GitHub account is no longer linked to your profile.' => 'Twoje konto GitHub nie jest juz zwiazany z Twoim profilu.' ,
    'Unable to unlink your GitHub Account.' => 'Nie mozna odlaczyc konto GitHub.',
    'Login with my GitHub Account' => 'Sie z moim kontem GitHub ',
    'Link my GitHub Account' => 'Polaczyc konto GitHub' ,
    'Unlink my GitHub Account'  => 'Odlaczanie moje konto GitHub ',
    'Created by %s' => 'Utworzony przez %s',
    'Last modified on %B %e, %Y at %k:%M %p' => 'Ostatnia modyfikacja %b %e,%Y w %k:%M %p ',
    'Tasks Export' => 'Zadania Eksport',
    'Tasks exportation for "%s"' => 'Zadania wywóz dla "%s"',
    ...
    'Completion date' => 'Data zakonczenia',
    'Webhook URL for task creation' => 'Webhook URL tworzenia zadania',
    'Webhook URL for task modification' => 'Webhook URL modyfikacji zadan',
    'Clone' => 'Klon',
    'Clone Project' => 'Projekt klon',
    'Project cloned successfully.' => 'Projekt sklonowany powodzeniem.',
    'Unable to clone this project.' => 'Nie można sklonować ten projekt.',		
);
