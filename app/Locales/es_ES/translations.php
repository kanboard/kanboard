...
return array(
    ...
    'Assign automatically a color based on a category' => 'Asignar automáticamente un color basado en una categoría',
    'Assign automatically a category based on a color' => 'Asignar automáticamente una categoría basada en un color',
    ...
    'Display another project' => 'Ver otro proyecto',
    'Your GitHub account was successfully linked to your profile.' => 'Su cuenta de GitHub estaba vinculado con éxito a tu perfil.',
    'Unable to link your GitHub Account.' => 'Incapaz de vincular su cuenta de GitHub.',
    'GitHub authentication failed' => 'Autenticación GitHub fracasó',
    'Your GitHub account is no longer linked to your profile.' => 'Su cuenta de GitHub ya no está vinculada a su perfil.',
    'Unable to unlink your GitHub Account.' => 'No es posible desvincular su cuenta de GitHub.',
    'Login with my GitHub Account' => 'Iniciar sesión con mi cuenta de GitHub',
    'Link my GitHub Account' => 'Relaciona mi cuenta de GitHub',
    'Unlink my GitHub Account'  => 'Desvincular mi cuenta de GitHub',
    'Created by %s' => 'Creado por %s',
    'Last modified on %B %e, %Y at %k:%M %p' => 'Ultima modificacion el %B %e, %Y a las %k:%M %p',
    'Tasks Export' => 'Tareas Exportar',
    'Tasks exportation for "%s"' => 'Tareas exportación de "%s"',
    ...
    'Webhook URL for task creation' => 'Webhook URL para la creación de tarea',
    'Webhook URL for task modification' => 'Webhook URL para la modificación de tarea',
    'Clone Project' => 'Proyecto Clon',
    'Project cloned successfully.' => 'Proyecto clonado con éxito.',
    'Unable to clone this project.' => 'No es posible clonar este proyecto.',		
);
