...
return array(
    ...
    'Estimate:' => '估算：',
    'Spent:' => '花费：',
    'Do you really want to remove this sub-task?' => '你真的要删除此子任务？',
    'Remaining:' => '剩余：',
    'hours' => '钟点',
    'spent' => '花',
    'estimated' => '预计',
    ...
    'Unable to update your sub-task.' => '无法更新你的子任务。',
    'Unable to create your sub-task.' => '无法创建子任务。',
    'Sub-task added successfully.' => '子任务添加成功。',
    'Maximum size: ' => '最大尺寸：',
    'Unable to upload the file.' => '无法上传文件。',
    'Display another project' => '显示另一个项目',
    'Your GitHub account was successfully linked to your profile.' => '你的GitHub的帐户已成功连接到您的个人资料。',
    'Unable to link your GitHub Account.' => '无法连接您的GitHub上的帐户。',
    'GitHub authentication failed' => 'GitHub的身份验证失败',
    'Your GitHub account is no longer linked to your profile.' => '你的GitHub的帐户不再链接到您的个人资料。',
    'Unable to unlink your GitHub Account.' => '无法取消链接你的GitHub上的帐户。',
    'Login with my GitHub Account' => '登录我的GitHub帐号',
    'Link my GitHub Account' => '链接我的GitHub帐号',
    'Unlink my GitHub Account'  => '取消链接我的GitHub帐号',
    'Created by %s' => '建立被%s',
    'Last modified on %B %e, %Y at %k:%M %p' => '最后修改于%d/%m/%Y %H:%M',
    'Tasks Export' => '任务导出',
    'Tasks exportation for "%s"' => '出口任务的"%s"',
    'Start Date' => '开始日期',
    'End Date' => '结束日期',
    'Execute' => '执行',
    'Task Id' => '任务ID',
