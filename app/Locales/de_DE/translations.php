...
return array(
    ...
    '[%s][Comment updated] %s (#%d)' => '[%s][Kommentar aktualisiert] %s (#%d)',
    ...
    '[%s][Task closed] %s (#%d)' => '[%s][Aufgabe abgeschlossen] %s (#%d)',
    '[%s][Task opened] %s (#%d)' => '[%s][Aufgabe geöffnet] %s (#%d)',
    '[%s][Due tasks]' => '[%s][Fällige Aufgaben]',
    '[Kanboard] Notification' => '[Kanboard] Benachrichtigungen',
    ...
    'Allow everybody to access to this project' => 'Allen Benutzern Zugriff zu diesem Projekt gewähren',
    'Everybody have access to this project.' => 'Alle Benutzer haben Zugriff zu diesem Projekt',
);
