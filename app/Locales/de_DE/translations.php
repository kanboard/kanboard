...
return array(
    ...
    'Clone this project' => 'Projekt duplizieren',
    ...
    'Categories management' => 'Kategorieverwaltung',
    ...
    '%s change the assignee of the task #%d' => '%s hat die Zusständigkeit der Aufgabe #%d geändert',
    '%s change the assignee of the task <a href="?controller=task&amp;action=show&amp;task_id=%d">#%d</a>' => '%s hat die Zuständigkeit der Aufgabe <a href="?controller=task&amp;action=show&amp;task_id=%d">#%d</a> geändert',
