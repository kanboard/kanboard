<span class="dropdown">
    <span>
        ...
        <ul>
            ...
            <li><i class="fa fa-pencil-square-o"></i> <?= $this->url->link(t('Flag/Unflag this task'), 'task', 'flag', array('task_id' => $task['id'], 'project_id' => $task['project_id']), false, 'task-board-popover') ?></li>
