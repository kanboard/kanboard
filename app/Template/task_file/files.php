                    ...
                    <div class="dropdown">
                        ...
                        <ul>
                            <?php if ($this->file->getPreviewType($file['name']) !== null): ?>
                                <li>
                                    <?= $this->url->link('<i class="fa fa-eye fa-fw"></i>' . t('View file'), 'FileViewerController', 'show', array('task_id' => $task['id'], 'project_id' => $task['project_id'], 'file_id' => $file['id']), false, 'popover') ?>
                                </li>
                            <?php endif ?>
                            <li>
                            ...
                            <?php if ($this->user->hasProjectAccess('TaskFileController', 'remove', $task['project_id'])): ?>
                                <li>
                                    <?= $this->url->link('<i class="fa fa-trash fa-fw"></i>' . t('Remove'), 'TaskFileController', 'confirm', array('task_id' => $task['id'], 'project_id' => $task['project_id'], 'file_id' => $file['id']), false, 'popover') ?>
                                </li>
                            <?php endif ?>
                        </ul>
                    </div>
