<section id="main">
    <div class="page-header">
        <ul>
            ...
            <li><?= $this->url->link('<i class="fa fa-plus fa-fw"></i>' . t('Add group member'), 'GroupListController', 'associate', array('group_id' => $group['id']), false, 'popover') ?></li>
        </ul>
    </div>
    ...
    <?php else: ?>
        <table class="table-striped table-scrolling">
            ...
            <tr>
                ...
                <td>
                    <?= $this->url->link('<i class="fa fa-times fa-fw" aria-hidden="true"></i>' . t('Remove this user'), 'GroupListController', 'dissociate', array('group_id' => $group['id'], 'user_id' => $user['id']), false, 'popover') ?>
                </td>
            </tr>
            <?php endforeach ?>
        </table>
