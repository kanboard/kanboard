<ul class="views">
    ...
    <?= $this->hook->render('template:project-header:view-switcher-before-ProjectOverview', array('project' => $project, 'filters' => $filters)) ?>
    ...
    <?= $this->hook->render('template:project-header:view-switcher-before-BoardView', array('project' => $project, 'filters' => $filters)) ?>
    ...
    <?= $this->hook->render('template:project-header:view-switcher-before-TaskList', array('project' => $project, 'filters' => $filters)) ?>
