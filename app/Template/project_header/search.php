<div class="filter-box">
    <form method="get" action="<?= $this->url->dir() ?>" class="search">
        ...
        <div class="input-addon">
            ...
            <div class="input-addon-item">
                <div class="dropdown">
                    <a href="#" class="dropdown-menu dropdown-menu-link-icon" title="<?= t('Custom filters') ?>"><em class="fa fa-bookmark fa-fw"></em><em class="fa fa-caret-down"></em></a>
                    <ul>
            ...
            <div class="input-addon-item">
                <div class="dropdown">
                    <a href="#" class="dropdown-menu dropdown-menu-link-icon" title="<?= t('User filters') ?>"><em class="fa fa-user fa-fw"></em> <em class="fa fa-caret-down"></em></a>
                    <ul>
            ...
            <div class="input-addon-item">
                <div class="dropdown">
                    <a href="#" class="dropdown-menu dropdown-menu-link-icon" title="<?= t('Category filters') ?>"><em class="fa fa-folder-open fa-fw"></em><em class="fa fa-caret-down"></em></a>
                    <ul>
