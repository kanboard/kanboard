...
defined('REVERSE_PROXY_NAME_HEADER') or define('REVERSE_PROXY_NAME_HEADER', 'AUTH-NAME');
defined('REVERSE_PROXY_MAIL_HEADER') or define('REVERSE_PROXY_MAIL_HEADER', 'AUTH-MAIL');
