...
defined('REVERSE_PROXY_NAME_HEADER') or define('REVERSE_PROXY_NAME_HEADER', 'John Doe');
defined('REVERSE_PROXY_MAIL_HEADER') or define('REVERSE_PROXY_MAIL_HEADER', 'mail@test.com');
defined('REVERSE_PROXY_GET_FIELDS') or define('REVERSE_PROXY_GET_FIELDS', False);
