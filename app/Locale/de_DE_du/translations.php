...
return [
    ...
    'Reorder this column by id (ASC)' => 'Ordne diese Spalte nach ID neu (aufsteigend)',
    'Reorder this column by id (DESC)' => 'Ordne diese Spalte nach ID neu (absteigend)',
    ...
    'Reply' => 'Antworten',
    '%s wrote: ' => '%s schrieb:',
    'Number of visible tasks in this column and swimlane' => 'Anzahl der sichtbaren Aufgaben in dieser Spalte und Lane',
    'Number of tasks in this swimlane' => 'Anzahl der Aufgaben in dieser Lane',
    'Unable to find another subtask in progress, you can close this window.' => 'Es konnte kein weiterer Teilaufgabe in Bearbeitung gefunden werden, du kannst dieses Fenster schließen.',
    ...
    'Color invalid' => 'Farbe ungültig',
    'This value must be greater or equal to %d' => 'Dieser Wert muss größer oder gleich %d sein',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Füge eine BOM am Anfang der Datei hinzu (für Microsoft Excel erforderlich)',
    ...
    'Select the project to copy tasks from' => 'Wähle das Projekt aus, aus dem Aufgaben kopiert werden sollen',
    ...
    'Enable notifications by default for all new users' => 'Aktiviere Benachrichtigungen standardmäßig für alle neuen Benutzer',
];
