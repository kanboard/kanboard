...
return array(
    ...
    'Close a task in a specific column when not moved during a given period' => 'Stäng en uppgift inom en viss kolumn när den inte flyttats under en given tidsperiod',
    'Edit columns' => 'Ändra kolumner',
    'The column restriction has been created successfully.' => 'Kolumnrestriktion har skapats.',
    'Unable to create this column restriction.' => 'Kunde inteskapa kolumnrestriktion.',
    'Column restriction removed successfully.' => 'Kolumnrestriktion togs bort.',
    'Unable to remove this restriction.' => 'Kunde inte flytta restriktionen.',
    'Your custom project role has been created successfully.' => 'Din anpassade projektroll har skapats.',
    'Unable to create custom project role.' => 'Kunde inte skapa din anpassade projektroll.',
    'Your custom project role has been updated successfully.' => 'Din anpassade projektroll har uppdaterats.',
    'Unable to update custom project role.' => 'Kunde inte uppdatera din anpassade projektroll.',
    'Custom project role removed successfully.' => 'Anpassad projektroll togs bort.',
    'Unable to remove this project role.' => 'Kan inte ta bort denna projektrollen.',
    'The project restriction has been created successfully.' => 'Projektrestriktionen har skapats.',
    'Unable to create this project restriction.' => 'Kunde inte skapa projektrestriktionen.',
    'Project restriction removed successfully.' => 'Projektrestriktionen togs bort.',
    'You cannot create tasks in this column.' => 'Du kan inte skapa uppgifter i denna kolumn.',
    'Task creation is permitted for this column' => 'Skapande av uppgifter i denna kolumn tillåten',
    'Closing or opening a task is permitted for this column' => 'Stängning eller öppning av uppgift i denna kolumn är tillåten',
    'Task creation is blocked for this column' => 'Skapande av uppgifter i denna kolumnen är blockerad',
    'Closing or opening a task is blocked for this column' => 'Stängning eller öppning av uppgift i denna kolumn är blockerad',
    'Task creation is not permitted' => 'Skapande av uppgift är ej tillåten',
    'Closing or opening a task is not permitted' => 'Stängning eller öppning av uppgift är ej tillåten',
    'New drag and drop restriction for the role "%s"' => 'Ny dra-och-släpprestriktion för rollen "%s"',
    'People belonging to this role will be able to move tasks only between the source and the destination column.' => 'Användare som hör till denna rollen kommer endast kunna flytta uppgifter mellan käll- och destinationskolumn.',
    'Remove a column restriction' => 'Ta bort en kolumnrestriktion',
    'Do you really want to remove this column restriction: "%s" to "%s"?' => 'Vill du verkligen ta bort kolumnrestriktion: "%s" till "%s"?',
    'New column restriction for the role "%s"' => 'Ny kolumnrestriktion för roll "%s"',
    'Rule' => 'Regel',
    'Do you really want to remove this column restriction?' => 'Vill du verkligen ta bort kolumnrestriktionen?',
    'Custom roles' => 'Anpassade roller',
    'New custom project role' => 'Ny anpassad projektrol',
    'Edit custom project role' => 'Ändra anpassad projektrll',
    'Remove a custom role' => 'Ta bort en anpassad projektroll',
