...
return [
    ...
    '(Gzip compressed Sqlite file)' => '(gzip-komprimerad SQLite-fil)',
    ...
    'The maximum length is %d characters' => 'Maximalt antal tecken är %d',
    'The minimum length is %d characters' => 'Minsta antal tecken är %d',
    ...
    'Close a task in a specific column when not moved during a given period' => 'Stäng en uppgift i en specifik kolumn om den inte flyttas under en viss period',
    'Edit columns' => 'Redigera kolumner',
    'The column restriction has been created successfully.' => 'Kolumnbegränsningen har skapats.',
    'Unable to create this column restriction.' => 'Det gick inte att skapa denna kolumnbegränsning.',
    'Column restriction removed successfully.' => 'Kolumnbegränsningen har tagits bort.',
    'Unable to remove this restriction.' => 'Det gick inte att ta bort denna begränsning.',
    'Your custom project role has been created successfully.' => 'Din anpassade projektroll har skapats.',
    'Unable to create custom project role.' => 'Det gick inte att skapa anpassad projektroll.',
    'Your custom project role has been updated successfully.' => 'Din anpassade projektroll har uppdaterats.',
    'Unable to update custom project role.' => 'Det gick inte att uppdatera anpassad projektroll.',
    'Custom project role removed successfully.' => 'Anpassad projektroll har tagits bort.',
    'Unable to remove this project role.' => 'Det gick inte att ta bort denna projektroll.',
    'The project restriction has been created successfully.' => 'Projektbegränsningen har skapats.',
    'Unable to create this project restriction.' => 'Det gick inte att skapa denna projektbegränsning.',
    'Project restriction removed successfully.' => 'Projektbegränsningen har tagits bort.',
    'You cannot create tasks in this column.' => 'Du kan inte skapa uppgifter i denna kolumn.',
    'Task creation is permitted for this column' => 'Uppgiftsskapande är tillåtet för denna kolumn',
    'Closing or opening a task is permitted for this column' => 'Att stänga eller öppna en uppgift är tillåtet för denna kolumn',
    'Task creation is blocked for this column' => 'Uppgiftsskapande är blockerat för denna kolumn',
    'Closing or opening a task is blocked for this column' => 'Att stänga eller öppna en uppgift är blockerat för denna kolumn',
    'Task creation is not permitted' => 'Uppgiftsskapande är inte tillåtet',
    'Closing or opening a task is not permitted' => 'Att stänga eller öppna en uppgift är inte tillåtet',
    'New drag and drop restriction for the role "%s"' => 'Ny dra-och-släpp-begränsning för rollen "%s"',
    'People belonging to this role will be able to move tasks only between the source and the destination column.' => 'Personer med denna roll kan endast flytta uppgifter mellan käll- och destinationskolumnen.',
    'Remove a column restriction' => 'Ta bort en kolumnbegränsning',
    'Do you really want to remove this column restriction: "%s" to "%s"?' => 'Vill du verkligen ta bort denna kolumnbegränsning: "%s" till "%s"?',
    'New column restriction for the role "%s"' => 'Ny kolumnbegränsning för rollen "%s"',
    'Rule' => 'Regel',
    'Do you really want to remove this column restriction?' => 'Vill du verkligen ta bort denna kolumnbegränsning?',
    'Custom roles' => 'Anpassade roller',
    'New custom project role' => 'Ny anpassad projektroll',
    'Edit custom project role' => 'Redigera anpassad projektroll',
    'Remove a custom role' => 'Ta bort en anpassad roll',
    'Do you really want to remove this custom role: "%s"? All people assigned to this role will become project member.' => 'Vill du verkligen ta bort denna anpassade roll: "%s"? Alla personer tilldelade denna roll kommer att bli projektmedlemmar.',
    ...
    'Reorder this column by id (ASC)' => 'Sortera denna kolumn efter ID (stigande)',
    'Reorder this column by id (DESC)' => 'Sortera denna kolumn efter ID (fallande)',
    ...
    'Automatically set the due date when the task is moved away from a specific column' => 'Ställ automatiskt in förfallodatum när uppgiften flyttas från en specifik kolumn',
    'No other projects found.' => 'Inga andra projekt hittades.',
    'Tasks copied successfully.' => 'Uppgifter kopierades framgångsrikt.',
    'Unable to copy tasks.' => 'Det gick inte att kopiera uppgifter.',
    'Theme' => 'Tema',
    'Theme:' => 'Tema:',
    'Light theme' => 'Ljust tema',
    'Dark theme' => 'Mörkt tema',
    'Automatic theme - Sync with system' => 'Automatiskt tema – synkronisera med systemet',
    'Application managers or more' => 'Applikationsansvariga eller högre',
    'Administrators' => 'Administratörer',
    'Visibility:' => 'Synlighet:',
    'Standard users' => 'Standardanvändare',
    'Visibility is required' => 'Synlighet krävs',
    'The visibility should be an app role' => 'Synligheten bör vara en applikationsroll',
    'Reply' => 'Svara',
    '%s wrote: ' => '%s skrev: ',
    'Number of visible tasks in this column and swimlane' => 'Antal synliga uppgifter i denna kolumn och simlinje',
    'Number of tasks in this swimlane' => 'Antal uppgifter i denna simlinje',
    'Unable to find another subtask in progress, you can close this window.' => 'Kunde inte hitta en annan deluppgift i gång, du kan stänga detta fönster.',
    'This theme is invalid' => 'Detta tema är ogiltigt',
    'This role is invalid' => 'Denna roll är ogiltig',
    'This timezone is invalid' => 'Denna tidszon är ogiltig',
    'This language is invalid' => 'Detta språk är ogiltigt',
    'This URL is invalid' => 'Denna URL är ogiltig',
    'Date format invalid' => 'Ogiltigt datumformat',
    'Time format invalid' => 'Ogiltigt tidsformat',
    'Invalid Mail transport' => 'Ogiltig e-posttransport',
    'Color invalid' => 'Ogiltig färg',
    'This value must be greater or equal to %d' => 'Detta värde måste vara större än eller lika med %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Lägg till en BOM i början av filen (krävs för Microsoft Excel)',
    'Just add these tag(s)' => 'Lägg bara till dessa taggar',
    'Remove internal link(s)' => 'Ta bort interna länkar',
    'Import tasks from another project' => 'Importera uppgifter från ett annat projekt',
    'Select the project to copy tasks from' => 'Välj projektet att kopiera uppgifter från',
