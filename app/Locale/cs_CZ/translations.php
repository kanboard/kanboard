...
return [
    ...
    'PEN - Peruvian Sol' => 'PEN - Peruánský sol',
    ...
    'Reorder this column by id (ASC)' => 'Přerovnat tento sloupec podle ID (vzestupně)',
    'Reorder this column by id (DESC)' => 'Přerovnat tento sloupec podle ID (sestupně)',
    ...
    'MXN - Mexican Peso' => 'MXN - Mexické peso',
    'Estimated vs actual time per column' => 'Odhadovaný vs. skutečný čas na sloupec',
    'HUF - Hungarian Forint' => 'HUF - Maďarský forint',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => 'Musíte vybrat soubor, který nahrajete jako svého avatara!',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'Soubor, který jste nahráli, není platný obrázek! (Povoleny jsou pouze *.gif, *.jpg, *.jpeg a *.png!)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Automaticky nastavit datum splatnosti, když je úkol přesunut z konkrétního sloupce',
    'No other projects found.' => 'Nebyly nalezeny žádné další projekty.',
    'Tasks copied successfully.' => 'Úkoly úspěšně zkopírovány.',
    'Unable to copy tasks.' => 'Nelze kopírovat úkoly.',
    'Theme' => 'Téma',
    'Theme:' => 'Téma:',
    'Light theme' => 'Světlé téma',
    'Dark theme' => 'Tmavé téma',
    'Automatic theme - Sync with system' => 'Automatické téma - Synchronizace se systémem',
    'Application managers or more' => 'Správci aplikace a vyšší',
    'Administrators' => 'Administrátoři',
    'Visibility:' => 'Viditelnost:',
    'Standard users' => 'Standardní uživatelé',
    'Visibility is required' => 'Viditelnost je povinná',
    'The visibility should be an app role' => 'Viditelnost by měla být rolí aplikace',
    'Reply' => 'Odpovědět',
    '%s wrote: ' => '%s napsal:',
    'Number of visible tasks in this column and swimlane' => 'Počet viditelných úkolů v tomto sloupci a plavecké dráze',
    'Number of tasks in this swimlane' => 'Počet úkolů v této plavecké dráze',
    'Unable to find another subtask in progress, you can close this window.' => 'Nelze najít další probíhající dílčí úkol, můžete zavřít toto okno.',
    'This theme is invalid' => 'Toto téma je neplatné',
    'This role is invalid' => 'Tato role je neplatná',
    'This timezone is invalid' => 'Toto časové pásmo je neplatné',
    'This language is invalid' => 'Tento jazyk je neplatný',
    'This URL is invalid' => 'Tato URL adresa je neplatná',
    'Date format invalid' => 'Neplatný formát data',
    'Time format invalid' => 'Neplatný formát času',
    'Invalid Mail transport' => 'Neplatný přenos pošty',
    'Color invalid' => 'Neplatná barva',
    'This value must be greater or equal to %d' => 'Tato hodnota musí být větší nebo rovna %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Přidat BOM na začátek souboru (vyžadováno pro Microsoft Excel)',
    'Just add these tag(s)' => 'Stačí přidat tyto štítky',
    'Remove internal link(s)' => 'Odebrat interní odkaz(y)',
    'Import tasks from another project' => 'Importovat úkoly z jiného projektu',
    'Select the project to copy tasks from' => 'Vyberte projekt, ze kterého chcete úkoly kopírovat',
