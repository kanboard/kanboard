...
return array(
    ...
    'Automatically update the start date when task move away from certain column' => 'Automatically update the start date when task move away from certain column',
