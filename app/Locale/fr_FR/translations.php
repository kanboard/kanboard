...
return array(
    ...
    'Custom Project Roles' => 'Rôles personalisés',
    'Add a new custom role' => 'Ajouter un rôles personalisé',
    'Restrictions for the role "%s"' => 'Restrictions pour le rôle "%s"',
    'Add a new project restriction' => 'Ajouter une restriction pour ce projet',
    'Add a new drag and drop restriction' => 'Ajouter une restriction pour le glisser-déposer',
    'Add a new column restriction' => 'Ajouter une restriction pour les colonnes',
    'Edit this role' => 'Editer ce rôle',
    'Remove this role' => 'Supprimer ce rôle',
    'Actions' => 'Actions',
    'There is no restriction for this role.' => 'Il n\'y a pas de restrictions pour ce rôle',
    'Project' => 'Projet',
    'Remove' => 'Supprimer',
