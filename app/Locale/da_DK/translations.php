...
return [
    ...
    'PEN - Peruvian Sol' => 'PEN – peruviansk sol',
    ...
    'Reorder this column by id (ASC)' => 'Sortér denne kolonne efter id (stigende)',
    'Reorder this column by id (DESC)' => 'Sortér denne kolonne efter id (faldende)',
    ...
    'No other projects found.' => 'Ingen andre projekter fundet.',
    'Tasks copied successfully.' => 'Opgaver blev kopieret med succes.',
    'Unable to copy tasks.' => 'Kunne ikke kopiere opgaver.',
    'Theme' => 'Tema',
    'Theme:' => 'Tema:',
    'Light theme' => 'Lyst tema',
    'Dark theme' => 'Mørkt tema',
    'Automatic theme - Sync with system' => 'Automatisk tema – synkroniser med systemet',
    'Application managers or more' => 'Applikationsansvarlige eller højere',
    'Administrators' => 'Administratorer',
    'Visibility:' => 'Synlighed:',
    'Standard users' => 'Standardbrugere',
    'Visibility is required' => 'Synlighed er påkrævet',
    'The visibility should be an app role' => 'Synligheden skal være en app-rolle',
    'Reply' => 'Svar',
    '%s wrote: ' => '%s skrev: ',
    'Number of visible tasks in this column and swimlane' => 'Antal synlige opgaver i denne kolonne og bane',
    'Number of tasks in this swimlane' => 'Antal opgaver i denne bane',
    'Unable to find another subtask in progress, you can close this window.' => 'Kunne ikke finde en anden underopgave i gang, du kan lukke dette vindue.',
    'This theme is invalid' => 'Dette tema er ugyldigt',
    'This role is invalid' => 'Denne rolle er ugyldig',
    'This timezone is invalid' => 'Denne tidszone er ugyldig',
    'This language is invalid' => 'Dette sprog er ugyldigt',
    'This URL is invalid' => 'Denne URL er ugyldig',
    'Date format invalid' => 'Ugyldigt datoformat',
    'Time format invalid' => 'Ugyldigt tidsformat',
    'Invalid Mail transport' => 'Ugyldig mailtransport',
    'Color invalid' => 'Ugyldig farve',
    'This value must be greater or equal to %d' => 'Værdien skal være større end eller lig med %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Tilføj en BOM i begyndelsen af filen (krævet af Microsoft Excel)',
    'Just add these tag(s)' => 'Tilføj blot disse mærker',
    'Remove internal link(s)' => 'Fjern interne links',
    'Import tasks from another project' => 'Importer opgaver fra et andet projekt',
    'Select the project to copy tasks from' => 'Vælg projektet, du vil kopiere opgaver fra',
    'The total maximum allowed attachments size is %sB.' => 'Den samlede maksimalt tilladte størrelse for vedhæftede filer er %sB.',
    ...
    'Assign the task to its creator for specific columns if no assignee is set manually' => 'Tildel opgaven til dens opretter for bestemte kolonner, hvis ingen ansvarlig er sat manuelt',
    'Assign a task to the logged user on column change to specified column if no user is assigned' => 'Tildel en opgave til den loggede bruger ved kolonneændring til den angivne kolonne, hvis ingen bruger er tildelt',
];
