...
return array(
    ...
    'Estimated vs actual time per column' => 'Tempo estimado vs tempo real por coluna',
    ...
    'Application managers or more' => 'Gerentes da aplicação ou mais',
    'Administrators' => 'Administradores',
    'Visibility:' => 'Visibilidade:',
    'Standard users' => 'Usuários comuns',
    'Visibility is required' => 'Visibilidade é obrigatória',
    'The visibility should be an app role' => 'A visibilidade deve ser uma função da aplicação',
    'Reply' => 'Responder',
    '%s wrote: ' => '%s escreveu:',
    ...
    'Unable to find another subtask in progress, you can close this window.' => 'Não foi possível encontrar outra subtarefa em progresso, você pode fechar esta janela.',
    'This theme is invalid' => 'Esse tema não é válido',
    'This role is invalid' => 'Essa função não é válida',
    'This timezone is invalid' => 'Esse fuso horário não é válido',
    'This language is invalid' => 'Esse idioma não é válido',
    'This URL is invalid' => 'Essa URL não é válida',
    'Date format invalid' => 'Formato de data inválido',
    'Time format invalid' => 'Formato de tempo inválido',
    'Invalid Mail transport' => 'Transportador de E-mail inválido',
