...
return array(
    ...
    'Average Lead and Cycle time' => 'Tempo médio do tempo de espera e tempo de ciclo',
    'Average lead time: ' => 'Tempo de espera médio: ',
    'Average cycle time: ' => 'Tempo de ciclo médio: ',
    'Cycle Time' => 'Tempo de ciclo',
    'Lead Time' => 'Tempo de espera',
    'This chart show the average lead and cycle time for the last %d tasks over the time.' => 'Este gráfico mostra o tempo médio do tempo de espera e tempo de ciclo das últimas %d tarefas.',
    'Average time into each column' => 'Tempo médio de cada coluna',
    'Lead and cycle time' => 'Tempo de espera e tempo de ciclo',
    'Lead time: ' => 'Tempo de espera: ',
    'Cycle time: ' => 'Tempo de ciclo: ',
    'Time spent into each column' => 'Tempo gasto em cada coluna',
    'The lead time is the duration between the task creation and the completion.' => 'O tempo de espera é o tempo gasto entre a criação da tarefa e a sua conclusão.',
