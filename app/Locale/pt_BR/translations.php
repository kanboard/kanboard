...
return array(
    ...
    // '%s updated the task %s' => '%s atualizar a tarefa %s',
    // '%s opened the task %s' => '%s abrir a tarefa %s',
    ...
    // '[%s][Column Change] %s (#%d)' => '[%s][Modificar Coluna] %s (#%d)',
    // '[%s][Position Change] %s (#%d)' => '[%s][Modificar Posição] %s (#%d)',
    // '[%s][Assignee Change] %s (#%d)' => '[%s][Modificar Designação] %s (#%d)',
