...
return array(
    ...
    'Reply' => 'Antworten',
    '%s wrote: ' => '%s schrieb:',
    'Number of visible tasks in this column and swimlane' => 'Anzahl der sichtbaren Aufgaben in dieser Spalte und Swimlane',
    'Number of tasks in this swimlane' => 'Anzahl der Aufgaben in dieser Swimlane',
    'Unable to find another subtask in progress, you can close this window.' => 'Es konnte keine andere Teilaufgabe in Bearbeitung gefunden werden, Sie können dieses Fenster schließen.',
    ...
    'Date format invalid' => 'Datumsformat ungültig',
    'Time format invalid' => 'Zeitformat ungültig',
    ...
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Fügen Sie eine BOM am Anfang der Datei hinzu (erforderlich für Microsoft Excel)',
    ...
    'Import tasks from another project' => 'Importiere Aufgaben aus einem anderen Projekt',
    'Select the project to copy tasks from' => 'Wählen Sie das Projekt aus, aus dem die Aufgaben kopiert werden sollen',
);
