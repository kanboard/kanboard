...
return array(
    ...
    'Application settings' => 'Configurações da aplicacção',
    'Language' => 'Idioma',
    ...
    'The confirmation is required' => 'A confirmacção é obrigatória',
    ...
    'Database optimization done.' => 'Otimizacção da base de dados finalizada.',
    ...
    'Done' => 'Finalizado',
    'Application version:' => 'Versão da aplicacção:',
    'Completed on %B %e, %Y at %k:%M %p' => 'Finalizado em %d %B %Y às %H:%M',
    '%B %e, %Y at %k:%M %p' => '%d %B %Y às %H:%M',
    'Date created' => 'Data de criacção',
    'Date completed' => 'Data da finalizacção',
    'Id' => 'Id',
    ...
    'Change assignee' => 'Mudar a designacção',
    'Change assignee for the task "%s"' => 'Modificar designacção para a tarefa "%s"',
    'Timezone' => 'Fuso horário',
    'Sorry, I didn\'t find this information in my database!' => 'Desculpe, não encontrei esta informacção na minha base de dados!',
    ...
    'Task modification' => 'Modificacção de tarefa',
    ...
    'Expiration date' => 'Data de expiracção',
    'Remember Me' => 'Lembre-se de mim',
    'Creation date' => 'Data de criacção',
    'Everybody' => 'Todos',
    'Open' => 'Abrir',
    'Closed' => 'Finalizado',
    'Search' => 'Pesquisar',
    ...
    'External authentication failed' => 'Autenticacção externa falhou',
    ...
    'Last modified on %B %e, %Y at %k:%M %p' => 'Última modificacção em %B %e, %Y às %k: %M %p',
    ...
    'Creator' => 'Criado por',
    'Modification date' => 'Data da modificacção',
    'Completion date' => 'Data da finalizacção',
    'Clone' => 'Clonar',
    ...
    'Project activation' => 'Ativacção do projecto',
    ...
    'Password modification' => 'Alteracção de senha',
    'External authentications' => 'Autenticacção externa',
    ...
    '%s change the assignee of the task #%d to %s' => '%s mudou a designacção da tarefa #%d para %s',
    '%s changed the assignee of the task %s to %s' => '%s mudou a designacção da tarefa %s para %s',
    ...
    'Change the assignee based on an external username' => 'Alterar designacção com base num utilizador externo',
    ...
    'URL for task creation:' => 'URL para a criacção da tarefa:',
    'Reset token' => 'Redefinir token',
    'API endpoint:' => 'API endpoint:',
    'Refresh interval for private board' => 'Intervalo de actualizacção para um quadro privado',
    'Refresh interval for public board' => 'Intervalo de actualizacção para um quadro público',
    ...
    'Application URL' => 'URL da Aplicacção',
    ...
    'Daily project summary export' => 'Exportacção diária do resumo do projecto',
    ...
    'Swimlane modification for the project "%s"' => 'Modificacção de swimlane para o projecto "%s"',
    ...
    'Integration with third-party services' => 'Integracção com serviços de terceiros',
    ...
    'Untitled' => 'Sem título',
    'Application default' => 'Aplicacção padrão',
    'Language:' => 'Idioma',
    'Timezone:' => 'Fuso horário',
    ...
    'Link added successfully.' => 'Associacção criada com sucesso.',
    ...
    'Link modification' => 'Modificacção de uma associação',
    'Links' => 'Associações',
    'Link settings' => 'Configuracção das associações',
    ...
    'Task transitions export' => 'Exportacção das transições das tarefas',
    ...
    'Help on Slack integration' => 'Ajuda na integracção com o Slack',
    ...
    'Help on Hipchat integration' => 'Ajuda na integracção com o Hipchat',
    ...
    'Code' => 'Código',
    'Two factor authentication' => 'Autenticacção com factor duplo',
    ...
    'Help on Postmark integration' => 'Ajuda na integracção do Postmark',
    'Mailgun (incoming emails)' => 'Mailgun (e-mails recebidos)',
    'Help on Mailgun integration' => 'Ajuda na integracção do Mailgun',
    'Sendgrid (incoming emails)' => 'Sendgrid (e-mails recebidos)',
    'Help on Sendgrid integration' => 'Ajuda na integracção do Sendgrid',
    ...
    'Recurring information' => 'Informacção sobre a recorrência',
    'Score' => 'Complexidade',
    ...
    'Help on Jabber integration' => 'Ajuda na integracção com Jabber',
    ...
    'Show tasks based on the creation date' => 'Mostrar as tarefas em função da data de criacção',
    ...
    'Security' => 'Segurança',
    'Two factor authentication disabled' => 'Autenticacção com factor duplo desativado',
    'Two factor authentication enabled' => 'Autenticacção com factor duplo activado',
    ...
    'Search by due date: ' => 'Pesquisar por data de expiracção: ',
