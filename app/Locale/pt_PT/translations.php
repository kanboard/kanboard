...
return [
    ...
    'Close all tasks in this column and this swimlane' => 'Fechar todas as tarefas nesta coluna',
    ...
    'Tasks copied successfully.' => 'Tarefas copiadas com sucesso.',
    'Unable to copy tasks.' => 'Não foi possível copiar as tarefas.',
    'Theme' => 'Tema',
    'Theme:' => 'Tema:',
    'Light theme' => 'Tema claro',
    'Dark theme' => 'Tema escuro',
    'Automatic theme - Sync with system' => 'Tema automático – Sincronizar com o sistema',
    'Application managers or more' => 'Gestores da aplicação ou superior',
    'Administrators' => 'Administradores',
    'Visibility:' => 'Visibilidade:',
    'Standard users' => 'Utilizadores padrão',
    'Visibility is required' => 'A visibilidade é obrigatória',
    'The visibility should be an app role' => 'A visibilidade deve ser um papel da aplicação',
    'Reply' => 'Responder',
    '%s wrote: ' => '%s escreveu: ',
    'Number of visible tasks in this column and swimlane' => 'Número de tarefas visíveis nesta coluna e faixa',
    'Number of tasks in this swimlane' => 'Número de tarefas nesta faixa',
    'Unable to find another subtask in progress, you can close this window.' => 'Não foi possível encontrar outra subtarefa em progresso, pode fechar esta janela.',
    'This theme is invalid' => 'Este tema é inválido',
    'This role is invalid' => 'Este papel é inválido',
    'This timezone is invalid' => 'Este fuso horário é inválido',
    'This language is invalid' => 'Este idioma é inválido',
    'This URL is invalid' => 'Este URL é inválido',
    'Date format invalid' => 'Formato de data inválido',
    'Time format invalid' => 'Formato de hora inválido',
    'Invalid Mail transport' => 'Transporte de e-mail inválido',
    'Color invalid' => 'Cor inválida',
    'This value must be greater or equal to %d' => 'Este valor deve ser maior ou igual a %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Adicionar um BOM no início do ficheiro (necessário para Microsoft Excel)',
    'Just add these tag(s)' => 'Apenas adicione estas etiquetas',
    'Remove internal link(s)' => 'Remover ligações internas',
    'Import tasks from another project' => 'Importar tarefas de outro projeto',
    'Select the project to copy tasks from' => 'Selecionar o projeto de onde copiar as tarefas',
    'The total maximum allowed attachments size is %sB.' => 'O tamanho máximo total permitido para anexos é de %sB.',
    'Add attachments' => 'Adicionar anexos',
    'Task #%d "%s" is overdue' => 'Tarefa #%d "%s" está atrasada',
    'Enable notifications by default for all new users' => 'Ativar notificações por padrão para todos os novos usuários',
    'Assign the task to its creator for specific columns if no assignee is set manually' => 'Atribuir a tarefa ao seu criador para colunas específicas se nenhum responsável for definido manualmente',
    'Assign a task to the logged user on column change to specified column if no user is assigned' => 'Atribuir a tarefa ao utilizador com sessão iniciada ao mudar de coluna para a coluna especificada se nenhum utilizador estiver atribuído',
];
