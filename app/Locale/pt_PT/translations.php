...
return array(
    ...
    'Assigned to %s' => 'Assignado para %s',
    ...
    'Assign the task to a specific user' => 'Assignar a tarefa para um utilizador específico',
    'Assign the task to the person who does the action' => 'Assignar a tarefa à pessoa que executa a acção',
    ...
    'Assign a color to a specific user' => 'Assignar uma cor para um utilizador específico',
    ...
    'Assigned to %s with an estimate of %s/%sh' => 'Assignado para %s com tempo estimado de %s/%sh',
    ...
    '%s remove the assignee of the task %s' => '%s removeu a pessoa assignada para a tarefa %s',
    ...
    'Search by assignee: ' => 'Pesquisar por assignação: ',
