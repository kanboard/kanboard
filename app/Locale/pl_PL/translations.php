...
return [
    ...
    'Reorder this column by id (ASC)' => 'Sortuj tę kolumnę według ID (rosnąco)',
    'Reorder this column by id (DESC)' => 'Sortuj tę kolumnę według ID (malejąco)',
    ...
    'Automatically set the due date when the task is moved away from a specific column' => 'Automatycznie ustaw datę wykonania, gdy zadanie zostanie przeniesione z określonej kolumny',
    'No other projects found.' => 'Nie znaleziono innych projektów.',
    'Tasks copied successfully.' => 'Zadania skopiowane pomyślnie.',
    'Unable to copy tasks.' => 'Nie udało się skopiować zadań.',
    'Theme' => 'Motyw',
    'Theme:' => 'Motyw:',
    'Light theme' => 'Jasny motyw',
    'Dark theme' => 'Ciemny motyw',
    'Automatic theme - Sync with system' => 'Motyw automatyczny – synchronizuj z systemem',
    'Application managers or more' => 'Menedżerowie aplikacji lub wyżej',
    'Administrators' => 'Administratorzy',
    'Visibility:' => 'Widoczność:',
    'Standard users' => 'Użytkownicy standardowi',
    'Visibility is required' => 'Widoczność jest wymagana',
    'The visibility should be an app role' => 'Widoczność powinna odpowiadać roli w aplikacji',
    'Reply' => 'Odpowiedz',
    '%s wrote: ' => '%s napisał(a): ',
    'Number of visible tasks in this column and swimlane' => 'Liczba widocznych zadań w tej kolumnie i torze',
    'Number of tasks in this swimlane' => 'Liczba zadań w tym torze',
    'Unable to find another subtask in progress, you can close this window.' => 'Nie znaleziono innego podzadania w toku, możesz zamknąć to okno.',
    'This theme is invalid' => 'Ten motyw jest nieprawidłowy',
    'This role is invalid' => 'Ta rola jest nieprawidłowa',
    'This timezone is invalid' => 'Ta strefa czasowa jest nieprawidłowa',
    'This language is invalid' => 'Ten język jest nieprawidłowy',
    'This URL is invalid' => 'Ten adres URL jest nieprawidłowy',
    'Date format invalid' => 'Nieprawidłowy format daty',
    'Time format invalid' => 'Nieprawidłowy format czasu',
    'Invalid Mail transport' => 'Nieprawidłowy sposób przesyłania poczty',
    'Color invalid' => 'Nieprawidłowy kolor',
    'This value must be greater or equal to %d' => 'Ta wartość musi być większa lub równa %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Dodaj BOM na początku pliku (wymagane dla Microsoft Excel)',
    'Just add these tag(s)' => 'Po prostu dodaj te tagi',
    'Remove internal link(s)' => 'Usuń wewnętrzne odnośniki',
    'Import tasks from another project' => 'Importuj zadania z innego projektu',
    'Select the project to copy tasks from' => 'Wybierz projekt, z którego chcesz skopiować zadania',
    'The total maximum allowed attachments size is %sB.' => 'Maksymalny dozwolony rozmiar załączników to %sB.',
    'Add attachments' => 'Dodaj załączniki',
    'Task #%d "%s" is overdue' => 'Zadanie nr %d "%s" jest przeterminowane',
    'Enable notifications by default for all new users' => 'Włącz powiadomienia domyślnie dla wszystkich nowych użytkowników',
    'Assign the task to its creator for specific columns if no assignee is set manually' => 'Przypisz zadanie do jego twórcy dla określonych kolumn, jeśli nie ustawiono ręcznie osoby odpowiedzialnej',
    'Assign a task to the logged user on column change to specified column if no user is assigned' => 'Przypisz zadanie do zalogowanego użytkownika przy zmianie kolumny na wskazaną, jeśli nie ma przypisanego użytkownika',
];
