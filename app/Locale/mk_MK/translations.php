...
return array(
    ...
    'Канборд Invitation' => 'Покана за Канборд',
    ...
    'You have been invited to register on Канборд.' => 'Вие сте поканети да се регистрирате на Канборд.',
    ...
    'A link to reset your password has been sent by email.' => 'Врската за ресетирање на лозинката е испратена преку е-пошта.',
    'Your profile must have a valid email address.' => 'Профилот мора да има важечка адреса за е-пошта.',
    'Unfortunately, we are unable to reset your password. Did you enter a valid username? Do you have an email address in your profile?' => 'За жал, не можеме да ја поставиме вашата лозинка. Дали го внесовте точното корисничко име? Дали вашиот профил содржи адреса за е-пошта?',
    ...
    'Your are not member of any project.' => 'Вие не сте член на ниеден проект.',
    ...
    'Add a new Канборд task' => 'Додадете нова задача на Канборд',
