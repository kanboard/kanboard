...
return [
    ...
    'PEN - Peruvian Sol' => 'ПЕН - Перуански Сол',
    ...
    'Application managers or more' => 'Менаџери на апликации или повеќе',
    'Administrators' => 'Администратори',
    'Visibility:' => 'Видливост:',
    'Standard users' => 'Стандардни корисници',
    'Visibility is required' => 'Видливоста е задолжителна',
    'The visibility should be an app role' => 'Видливоста треба да биде улога на апликацијата',
    'Reply' => 'Одговори',
    '%s wrote: ' => '%s напиша: ',
    'Number of visible tasks in this column and swimlane' => 'Број на видливи задачи во оваа колона и патека',
    'Number of tasks in this swimlane' => 'Број на задачи во оваа патека',
    'Unable to find another subtask in progress, you can close this window.' => 'Не можам да најдам друг подзадача во тек, можете да го затворите овој прозорец.',
    'This theme is invalid' => 'Оваа тема е неважечка',
    'This role is invalid' => 'Оваа улога е неважечка',
    'This timezone is invalid' => 'Оваа временска зона е неважечка',
    'This language is invalid' => 'Овој јазик е неважечки',
    'This URL is invalid' => 'Оваа URL адреса е неважечка',
    'Date format invalid' => 'Неважечки формат на датум',
    'Time format invalid' => 'Неважечки формат на време',
    'Invalid Mail transport' => 'Неважечки транспорт на пошта',
    'Color invalid' => 'Неважечка боја',
    'This value must be greater or equal to %d' => 'Оваа вредност мора да биде поголема или еднаква на %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Додадете BOM на почетокот на датотеката (задолжително за Microsoft Excel)',
    'Just add these tag(s)' => 'Само додадете ги овие ознаки',
    'Remove internal link(s)' => 'Отстрани внатрешна врска(и)',
    'Import tasks from another project' => 'Увези задачи од друг проект',
    'Select the project to copy tasks from' => 'Изберете го проектот од кој сакате да копирате задачи',
