...
return [
    ...
    'Reorder this column by id (ASC)' => 'Kolonu id ye göre artan sırala',
    'Reorder this column by id (DESC)' => 'Kolonu id ye göre azalan sırala',
    ...
    'Assign the task to a specific user when the task is moved to a specific swimlane' => 'Görev belirli bir kulvara taşındığında belirli bir kullanıcıya ata',
    'Comment' => 'Yorum',
    'Collapse vertically' => 'Dikey olarak daralt',
    'Expand vertically' => 'Dikey olarak genişlet',
    'MXN - Mexican Peso' => 'MXN - Meksika Pesosu',
    'Estimated vs actual time per column' => 'Sütun başına tahmini ve gerçek zaman',
    'HUF - Hungarian Forint' => 'HUF - Macar Forinti',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => 'Avatarınız olarak yüklemek için bir dosya seçmelisiniz!',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'Yüklediğiniz dosya geçerli bir resim değil! (Yalnızca *.gif, *.jpg, *.jpeg ve *.png dosyalarına izin verilir!)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Görev belirli bir sütundan taşındığında son tarihi otomatik olarak ayarla',
    'No other projects found.' => 'Başka proje bulunamadı.',
    'Tasks copied successfully.' => 'Görevler başarıyla kopyalandı.',
    'Unable to copy tasks.' => 'Görevler kopyalanamıyor.',
    'Theme' => 'Tema',
    'Theme:' => 'Tema:',
    'Light theme' => 'Açık tema',
    'Dark theme' => 'Koyu tema',
    'Automatic theme - Sync with system' => 'Otomatik tema - Sistemle senkronize et',
    'Application managers or more' => 'Uygulama yöneticileri veya daha fazlası',
    'Administrators' => 'Yöneticiler',
    'Visibility:' => 'Görünürlük:',
    'Standard users' => 'Standart kullanıcılar',
    'Visibility is required' => 'Görünürlük gereklidir',
    'The visibility should be an app role' => 'Görünürlük bir uygulama rolü olmalıdır',
    'Reply' => 'Yanıtla',
    '%s wrote: ' => '%s yazdı: ',
    'Number of visible tasks in this column and swimlane' => 'Bu sütun ve yüzme yolunda görünen görev sayısı',
    'Number of tasks in this swimlane' => 'Bu yüzme yolundaki görev sayısı',
    'Unable to find another subtask in progress, you can close this window.' => 'Devam eden başka bir alt görev bulunamadı, bu pencereyi kapatabilirsiniz.',
    'This theme is invalid' => 'Bu tema geçersiz',
    'This role is invalid' => 'Bu rol geçersiz',
    'This timezone is invalid' => 'Bu saat dilimi geçersiz',
    'This language is invalid' => 'Bu dil geçersiz',
    'This URL is invalid' => 'Bu URL geçersiz',
    'Date format invalid' => 'Tarih biçimi geçersiz',
    'Time format invalid' => 'Saat biçimi geçersiz',
    'Invalid Mail transport' => 'Geçersiz posta aktarımı',
    'Color invalid' => 'Geçersiz renk',
    'This value must be greater or equal to %d' => 'Bu değer %d veya daha büyük olmalıdır',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Dosyanın başına BOM ekle (Microsoft Excel için gereklidir)',
    'Just add these tag(s)' => 'Sadece bu etiketleri ekle',
    'Remove internal link(s)' => 'Dahili bağlantıları kaldır',
    'Import tasks from another project' => 'Başka bir projeden görevleri içe aktar',
