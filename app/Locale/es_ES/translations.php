...
return [
    ...
    'Assigned' => 'Asignado',
    'Task limits apply to each swimlane individually' => 'Los límites de tareas se aplican a cada carril individualmente',
    ...
    'Column task limits are applied across swimlanes' => 'Los límites de tareas de columna se aplican a través de los carriles',
    'Task limit: ' => 'Límite de tareas: ',
    'Change to global tag' => 'Cambiar a etiqueta global',
    'Do you really want to make the tag "%s" global?' => '¿Realmente quieres hacer la etiqueta "%s" global?',
    ...
    '%d/%d group(s) shown' => '%d/%d grupo(s) mostrados',
    'Subtask creation or modification' => 'Creación o modificación de subtarea',
    'Assign the task to a specific user when the task is moved to a specific swimlane' => 'Asigne la tarea a un usuario específico cuando la tarea se mueva a un carril específico',
    'Comment' => 'Comentario',
    'Collapse vertically' => 'Colapsar verticalmente',
    'Expand vertically' => 'Expandir verticalmente',
    'MXN - Mexican Peso' => 'MXN - Peso mexicano',
    'Estimated vs actual time per column' => 'Tiempo estimado vs real por columna',
    'HUF - Hungarian Forint' => 'HUF - Forinto húngaro',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => '¡Debe seleccionar un archivo para subir como su avatar!',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => '¡El archivo que subió no es una imagen válida! (¡Solo se permiten *.gif, *.jpg, *.jpeg y *.png!)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Establecer automáticamente la fecha de vencimiento cuando la tarea se mueve de una columna específica',
    'No other projects found.' => 'No se encontraron otros proyectos.',
    'Tasks copied successfully.' => 'Tareas copiadas con éxito.',
    'Unable to copy tasks.' => 'No se pueden copiar las tareas.',
    'Theme' => 'Tema',
    'Theme:' => 'Tema:',
    'Light theme' => 'Tema claro',
    'Dark theme' => 'Tema oscuro',
    'Automatic theme - Sync with system' => 'Tema automático - Sincronizar con el sistema',
    'Application managers or more' => 'Gestores de la aplicación o más',
    'Administrators' => 'Administradores',
    'Visibility:' => 'Visibilidad:',
    'Standard users' => 'Usuarios estándar',
    'Visibility is required' => 'La visibilidad es obligatoria',
    'The visibility should be an app role' => 'La visibilidad debe ser un rol de la aplicación',
    'Reply' => 'Responder',
    '%s wrote: ' => '%s escribió: ',
    ...
    'Date format invalid' => 'Formato de fecha no válido',
    'Time format invalid' => 'Formato de hora no válido',
    'Invalid Mail transport' => 'Transporte de correo no válido',
    ...
    'Just add these tag(s)' => 'Agregar solo estas etiquetas',
    'Remove internal link(s)' => 'Eliminar enlaces internos',
    'Import tasks from another project' => 'Importar tareas de otro proyecto',
    'Select the project to copy tasks from' => 'Seleccione el proyecto del que desea copiar tareas',
