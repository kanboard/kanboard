...
return array(
    ...
    'Do you really want to close this task: "%s"?' => '¿Realmente quiere cerrar esta tarea: « %s » ?',
    ...
    'Reset all tokens' => 'Reiniciar todos los tokens',
    'All tokens have been regenerated.' => 'Todos los tokens han sido regeneradas.',
    'Unknown' => 'Desconocido',
    ...
    'Do you really want to disable this project: "%s"?' => '¿Realmente quiere desactivar este proyecto: "%s"?',
    'Do you really want to duplicate this project: "%s"?' => '¿Realmente quiere duplicar este proyecto: "%s"?',
    'Do you really want to enable this project: "%s"?' => '¿Realmente quiere activar este proyecto: "%s"?',
    ...
    '%s change the assignee of the task #%d to %s' => '%s cambiar la persona asignada de la tarea #%d a %s',
    ...
    'Assignee Change' => 'Cambio de Persona Asignada',
    ...
    'Gitlab commit received' => 'Envío a Gitlab recibido',
    'Gitlab issue opened' => 'Problema en Gitlab abierto',
    'Gitlab issue closed' => 'Problema en Gitlab cerrado',
    'Gitlab webhooks' => 'Webhooks Gitlab',
    'Help on Gitlab webhooks' => 'Ayuda con los Webhooks Gitlab',
    'Integrations' => 'Integraciones',
    'Integration with third-party services' => 'Integraciones para servicios de terceros',
    'Role for this project' => 'Rol para este proyecto',
    'Project manager' => 'Administración del proyecto',
    'Project member' => 'Mienbro del proyecto',
    'A project manager can change the settings of the project and have more privileges than a standard user.' => 'Un administrador del proyecto puede cambiar las configuraciones del proyecto y tiene mas privilegios que un usuario estándar',
    ...
    'Add a comment logging moving the task between columns' => 'Añadir un comentario de registro moviendo la tarea entre columnas',
    ...
    'Enable time tracking for subtasks' => 'Habilitar control de tiempo para subtareas',
    ...
    'Change dashboard view' => 'Cambiar vista del tablero',
    ...
    'Disable login form' => 'Deshabilitar formulario de ingreso',
    'Show/hide calendar' => 'Mostrar/ocultar calendario',
    'User calendar' => 'Calendario del usuario',
    'Bitbucket commit received' => 'Envío a Bitbucket recibido',
    'Bitbucket webhooks' => 'Webhooks Bitbucket',
    'Help on Bitbucket webhooks' => 'Ayuda con los Webhooks Bitbucket',
    'Start' => 'Inicio',
    'End' => 'Fin',
    'Task age in days' => 'Edad de la tarea en días',
    'Days in this column' => 'Días en esta columna',
    // '%dd' => '',
    'Add a link' => 'Añadir vínculo',
    ...
    'Links' => 'Vínculos',
    'Link settings' => 'Parámetros de vínculos',
    'Opposite label' => 'Etiquetas opuestas',
    'Remove a link' => 'Suprimir un vínculo',
    'Task\'s links' => 'Vínculos de las tareas',
    ...
    'since %B %e, %Y at %k:%M %p' => 'desde %B %e, %Y a %k:%M %p',
    'More filters' => 'Mas filtros',
    'Compact view' => 'Vista compacta',
    'Horizontal scrolling' => 'Desplazamiento horizontal',
    'Compact/wide view' => 'Vista compacta/amplia',
    'No results match:' => 'No hay resultados que coincidentes',
    'Remove hourly rate' => 'Suprimir tarifa por hora',
    'Do you really want to remove this hourly rate?' => '¿Realmente quiere suprimir esta tarifa por hora?',
    'Hourly rates' => 'Tarifas por hora',
    'Hourly rate' => 'Tarifa por hora',
    'Currency' => 'Moneda',
    'Effective date' => 'Fecha efectiva',
    'Add new rate' => 'Añadir nueva tarifa',
    'Rate removed successfully.' => 'Tarifa suprimida correctamente',
    'Unable to remove this rate.' => 'No se puede suprimir esta tarifa',
    'Unable to save the hourly rate.' => 'No se puede guardar esta tarifa por hora',
    'Hourly rate created successfully.' => 'Tarifa por hora creada correctamente',
    'Start time' => 'Hora de incio',
    'End time' => 'Hora de fin',
    'Comment' => 'Comentario',
    'All day' => 'Todo el día',
    'Day' => 'Día',
    'Manage timetable' => 'Administrar tabla de tiempo',
    'Overtime timetable' => 'Tabla de tiempo suplementario',
    'Time off timetable' => 'Tabla de tiempo libre',
    'Timetable' => 'Tabla de tiempo',
    'Work timetable' => 'Tabla de tiempo laboral',
    'Week timetable' => 'Tabla de tiempo semanal',
    'Day timetable' => 'Tabla de tiempo diaria',
    'From' => 'De',
    'To' => 'Para',
    'Time slot created successfully.' => 'Espacio de tiempo creado correctamente',
    'Unable to save this time slot.' => 'No se puede guardar este espacio de tiempo',
    'Time slot removed successfully.' => 'Espacio de tiempo suprimido correctamente',
    'Unable to remove this time slot.' => 'No se puede suprimir este espacio de tiempo',
    'Do you really want to remove this time slot?' => '¿Realmente quiere suprimir este espacio de tiempo',
    'Remove time slot' => 'Suprimir espacio de tiempo',
    'Add new time slot' => 'Añadir nuevo espacio de tiempo',
    'This timetable is used when the checkbox "all day" is checked for scheduled time off and overtime.' => 'Esta tabla de tiempo se utiliza cuando la casilla de verificación "todo el día" está marcada para un tiempo libre y tiempo suplementario programado',
    'Files' => 'Ficheros',
    'Images' => 'Imágenes',
    ...
    'Budget line removed successfully.' => 'Línea presupuestaria suprimida correctamente',
    ...
    'download' => 'descargar',
    'Do you really want to remove this budget line?' => '¿Realmente quiere suprimir esta línea presupuestaria?',
    // 'EUR - Euro' => '',
    'Expenses' => 'Gastos',
    'GBP - British Pound' => 'GBP - Libra británica',
    'INR - Indian Rupee' => 'INR - Rupia india',
    'JPY - Japanese Yen' => 'JPY - Yen japonés',
    'New budget line' => 'Nueva línea presupuestaria',
    'NZD - New Zealand Dollar' => 'NZD - Dólar de Nueva Zelanda',
    'Remove a budget line' => 'Suprimir una línea presupuestaria',
    'Remove budget line' => 'Suprimir línea presupuestaria',
    'RSD - Serbian dinar' => 'RSD - Dinar serbio',
    'The budget line have been created successfully.' => 'La línea presupuestaria ha sido creada correctamente',
    'Unable to create the budget line.' => 'No se puede crear la línea presupuestaria',
    'Unable to remove this budget line.' => 'No se puede suprimir la línea presupuestaria',
    ...
    'Show subtask estimates in the user calendar' => 'Mostrar los estimados de las subtareas en el calendario del usuario',
    ...
    'Add a new currency rate' => 'Añadir un nuevo tipo de cambio',
    'Currency rates are used to calculate project budget.' => 'Los tipos de cambio son utilizados para calcular el presupuesto del proyecto',
    ...
    'Help on Slack integration' => 'Ayuda con la integración de Slack',
    '%s remove the assignee of the task %s' => '%s removió la persona asignada de la tarea %s',
    'Send notifications to Hipchat' => 'Enviar notificaciones a Hipchat',
    'API URL' => 'URL del API',
    'Room API ID or name' => 'API ID de la sala o nombre',
    'Room notification token' => 'Token de notificación de la sala',
    'Help on Hipchat integration' => 'Ayuda con la integración de Hipchat',
    ...
    'Save the secret key in your TOTP software (by example Google Authenticator or FreeOTP).' => 'Guarde la clave secreta en su software TOTP (por ejemplo Google Authenticato o FreeOTP).',
