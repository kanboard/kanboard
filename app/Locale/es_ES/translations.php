...
return array(
    ...
    'This chart shows the average time spent into each column for the last %d tasks.' => 'Este gráfico muestra el tiempo promedio invertido en cada columna para las últimas %d tareas.',
