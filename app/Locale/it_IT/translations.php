...
return array(
    ...
    'Create another task' => 'Crea una nuova attività',
    'New task' => 'Nuovo task',
    ...
    'There is nobody assigned' => 'Nessuno è assegnato a questa attività',
    ...
    'Add a new task' => 'Aggiungere una nuova attività',
    ...
    'Unable to update your task.' => 'Impossibile modificare questa attività.',
    'Task updated successfully.' => 'Task modificato con successo.',
    'Unable to create your task.' => 'Impossibile creare questa attività.',
    ...
    'Task modification' => 'Modifica di un\'attività',
    ...
    '%s created a subtask for the task %s' => '%s ha creato un sotto-task per l\'attività %s',
    '%s updated a subtask for the task %s' => '%s ha aggiornato un sotto-task per l\'attività %s',
    ...
    'Move the task to another column when assigned to a user' => 'Sposta l\'attività in un\'altra colonna quando viene assegnato ad un utente',
    ...
    'Do you really want to close the task "%s" as well as all subtasks?' => 'Vuoi veramente chiudere l\'attività "%s" e i relativi sotto-task?',
    ...
    'Only for tasks created by me and assigned to me' => 'Solo per le attività create da me e assegnati a me',
    // '%%Y-%%m-%%d' => '',
    ...
    'No tasks found.' => 'Nessun\'attività trovato.',
    ...
    'The lead time is the duration between the task creation and the completion.' => 'Il tempo di consegna (Lead Time) è la durata tra la creazione di un\'attività ed il suo completamento.',
    'The cycle time is the duration between the start date and the completion.' => 'Il tempo di lavorazione (Cycle Time) è la durata tra la data di inizio della lavorazione di un\'attività ed il suo completamento.',
    'If the task is not closed the current time is used instead of the completion date.' => 'Se l\'attività non è chiuso sarà usata la data attuale invece della data di completamento.',
    ...
    'Close a task when there is no activity' => 'Chiudi un\'attività quando non c\'è nessuna attività',
    ...
    'Unable to convert the subtask.' => 'Impossibile convertire le sotto-attività.',
    ...
    'Do you really want to convert this sub-task to a task?' => 'Vuoi davvero convertire questo sotto-attività in un\'attività?',
    ...
    'Close a task when there is no activity in an specific column' => 'Chiudi un\'attività quando non vi è alcuna attività in una specifica colonna',
    '%s removed a subtask for the task #%d' => '%s rimosso un subtask per l\'attività #%d',
    ...
    '%s removed a subtask for the task %s' => '%s rimosso un subtask per l\'attività %s',
    'Comment removed' => 'Commento rimosso',
    'Subtask removed' => 'Subtask rimosso',
    '%s set a new internal link for the task #%d' => '%s imposta un nuovo link interno per l\'attività #%d',
    '%s removed an internal link for the task #%d' => '%s rimosso un link interno per l\'attività #%d',
    'A new internal link for the task #%d have been defined' => 'E\' stato definito un nuovo link interno per l\'attività #%d',
    'Internal link removed for the task #%d' => 'Link interno rimosso per l\'attività #%d',
    '%s set a new internal link for the task %s' => '%s imposta un nuovo link interno per l\'attività %s',
    '%s removed an internal link for the task %s' => '%s rimosso un link interno per l\'attività %s',
    'Automatically set the due date on task creation' => 'Imposta automaticamente la data di scadenza alla creazione del task',
    'Move the task to another column when closed' => 'Sposta l\'attività su un\'altra colonna quando viene chiuso',
    'Move the task to another column when not moved during a given period' => 'Sposta l\'attività su un\'altra colonna quando non viene spostato entro un certo periodo',
    'Dashboard for %s' => 'Dashboard per %s',
    'Tasks overview for %s' => 'Panoramica attività per %s',
    'Subtasks overview for %s' => 'Panoramica attività per %s',
    'Projects overview for %s' => 'Panoramica progetti per %s',
    'Activity stream for %s' => 'Flusso attività per %s',
    'Assign a color when the task is moved to a specific swimlane' => 'Assegna un colore quando l\'attività viene spostato su una specifica swimlane',
    'Assign a priority when the task is moved to a specific swimlane' => 'Assegna una priorità quando l\'attività viene spostato su una specifica swimlane',
    'User unlocked successfully.' => 'Utente sbloccato con successo.',
    'Unable to unlock the user.' => 'Impossibile sbloccare l\'utente.',
    'Move a task to another swimlane' => 'Sposta un\'attività su un\'altra swimlane',
    ...
    'Task creation is permitted for this column' => 'La creazione delle attività è permessa per questa colonna',
    'Closing or opening a task is permitted for this column' => 'Chiudere o aprire le attività è permesso per questa colonna',
    ...
    'Profile' => 'Profilo',
    'Application role' => 'Regola di applicazione',
    ...
    'There is no project.' => 'Non c\'è un progetto',
     'Sort' => 'Ordina',
    ...
    'Update only assigned tasks is permitted' => 'E\' permesso solo l\'aggiornamento delle attività assegnate',
