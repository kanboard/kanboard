...
return array(
    ...
    'View this task' => 'Visualizza questo compito',
    ...
    'Close a task' => 'Chiudi un compito',
    'Column' => 'Colonna',
    'Color' => 'Colore',
    'Assignee' => 'Assegnatario',
    'Create another task' => 'Crea un nuovo compito',
    'New task' => 'Nuovo compito',
    'Open a task' => 'Apri un compito',
    'Do you really want to open this task: "%s"?' => 'Desideri davvero aprire questo compito: "%s" ?',
    'Back to the board' => 'Torna alla bacheca',
    'There is nobody assigned' => 'Nessuno è assegnato a questo compito',
    'Column on the board:' => 'Colonna sulla bacheca: ',
    'Close this task' => 'Chiudi questo compito',
    'Open this task' => 'Apri questo compito',
    ...
    'Unable to open this task.' => 'Impossibile aprire questo compito.',
    'Task opened successfully.' => 'Il compito è stato aperto con successo.',
    'Unable to close this task.' => 'Impossibile chiudere questo compito.',
    'Task closed successfully.' => 'Task chiuso con successo.',
    'Unable to update your task.' => 'Impossibile modificare questo compito.',
    'Task updated successfully.' => 'Task modificato con successo.',
    'Unable to create your task.' => 'Impossibile creare questo compito.',
    ...
    'Task limit' => 'Limite di compito',
    'Task count' => 'Numero di compito',
    'User' => 'Utente',
    'Comments' => 'Commenti',
    ...
    'Assign the task to a specific user' => 'Assegna il compito ad un utente specifico',
    'Assign the task to the person who does the action' => 'Assegna il compito all\'utente che compie l\'azione',
    'Duplicate the task to another project' => 'Duplica il compito in altro progetto',
    'Move a task to another column' => 'Sposta un compito in un\'altra colonna',
    'Task modification' => 'Modifica di un compito',
    'Task creation' => 'Creazione di un compito',
    'Closing a task' => 'Chiusura di un compito',
    ...
    'Unable to remove this task.' => 'Impossibile cancellare questo compito.',
    'Remove a task' => 'Cancella un compito',
    'Do you really want to remove this task: "%s"?' => 'Vuoi davvero cancellare questo compito: "%s"?',
    ...
    'Estimate:' => 'Stimato:',
    'Spent:' => 'Trascorso:',
    'Do you really want to remove this sub-task?' => 'Vuoi davvero cancellare questo sotto-compito?',
    'Remaining:' => 'Rimangono',
    'hours' => 'ore',
    'estimated' => 'stimate',
    'Sub-Tasks' => 'Sotto-compito',
    'Add a sub-task' => 'Aggiungi un sotto-compito',
    'Original estimate' => 'Stima originale',
    'Create another sub-task' => 'Crea un altro sotto-compito',
    'Time spent' => 'Tempo trascorso',
    'Edit a sub-task' => 'Modifica un sotto-compito',
    'Remove a sub-task' => 'Cancella un sotto-compito',
    'The time must be a numeric value' => 'Il tempo deve essere un valore numerico',
    'Todo' => 'Da fare',
    'In progress' => 'In corso',
    'Sub-task removed successfully.' => 'Sotto-compito cancellato con successo.',
    'Unable to remove this sub-task.' => 'Impossibile cancellare questo sotto-compito.',
    'Sub-task updated successfully.' => 'Sotto-compito aggiornato con successo.',
    'Unable to update your sub-task.' => 'Impossibile aggiornare il tuo sotto-compito.',
    'Unable to create your sub-task.' => 'Impossibile creare il tuo sotto-compito.',
    'Maximum size: ' => 'Dimensioni massime: ',
    'Display another project' => 'Mostra un altro progetto',
    'Created by %s' => 'Creato da %s',
    'Tasks Export' => 'Export dei compito',
    'Start Date' => 'Data di inizio',
    'Execute' => 'Esegui',
    'Task Id' => 'Id del compito',
    'Creator' => 'Creatore',
    ...
    'The task #%d has been opened.' => 'Il compito #%d è stato aperto.',
    'The task #%d has been closed.' => 'Il compito #%d è stato chiuso.',
    ...
    'view the task on Kanboard' => 'visualizza il compito su Kanboard',
    ...
    'Move the task to another project' => 'Sposta il compito in un altro progetto',
    ...
    '%s updated a comment on the task %s' => '%s ha aggiornato un commento nel compito %s',
    ...
    'Task assignee change' => 'Cambia l\'assegnatario del compito',
    '%s changed the assignee of the task #%d to %s' => '%s dai l\'assegnazione del compito #%d a %s',
    ...
    'Subtasks Export' => 'Esporta i sotto-compiti',
    ...
    'Allow only one subtask in progress at the same time for a user' => 'Permetti un solo sotto-compito in corso per utente alla volta',
    'Edit column "%s"' => 'Modifica la colonna "%s"',
    'Select the new status of the subtask: "%s"' => 'Seleziona il nuovo status per il sotto-compito: "%s"',
    'Subtask timesheet' => 'Timesheet del sotto-compito',
    'There is nothing to show.' => 'Nulla da mostrare.',
    'Time Tracking' => 'Monitoraggio delle tempistiche',
    'You already have one subtask in progress' => 'Hai già un sotto-compito in corso',
    ...
    'Do you really want to remove this link with task #%d?' => 'Vuoi davvero rimuovere questa relazione dal compito #%d?',
    ...
    'Expand/collapse tasks' => 'Espandi/minimizza i compiti',
    ...
    'Move the task to another column when assignee is cleared' => 'Sposta il compito in un\'altra colonna quando l\'assegnatario viene cancellato',
    'Source column' => 'Colonna sorgente',
    'Transitions' => 'Transizioni',
    'Executer' => 'Esecutore',
    'Time spent in the column' => 'Tempo trascorso nella colonna',
    'Task transitions' => 'Transizioni dei compiti',
    'Task transitions export' => 'Export delle transizioni dei compiti',
    'This report contains all column moves for each task with the date, the user and the time spent for each transition.' => 'Questo report contiene tutti gli spotamenti di colonna per ogni compito con le date, l\'utente ed il tempo trascorso per ogni transizione',
    ...
    '%s removed the assignee of the task %s' => '%s rimuove l\'assegnatario del compito %s',
    ...
    'This chart show the task complexity over the time (Work Remaining).' => 'Questo grafico mostra la complessità dei compiti nel tempo (Lavoro residuo).',
    ...
    'Start to type task title...' => 'Inzia a digitare il titolo di un compito...',
    'A task cannot be linked to itself' => 'Un compito non può essere correlato a se stesso',
    'The exact same link already exists' => 'La stessa relazione risulta già esistente',
    'Recurrent task is scheduled to be generated' => 'Il compito ricorrente è pianificato per essere generato',
    'Score' => 'Punteggio',
    'The identifier must be unique' => 'L\'identificatore deve essere univoco',
    'This linked task id doesn\'t exists' => 'L\'id del compito correlato non esiste',
    'This value must be alphanumeric' => 'Questo valore deve essere alfanumerico',
    'Edit recurrence' => 'Modifica ricorrenza',
    'Generate recurrent task' => 'Genera compito ricorrente',
    'Trigger to generate recurrent task' => 'Trigger per generare il compito ricorrente',
    ...
    'This task has created this child task: ' => 'Questo compito ha creato il seguente compito figlio: ',
    'Day(s)' => 'Giorno/i',
    'Existing due date' => 'Data di scadenza esistente',
    'Factor to calculate new due date: ' => 'Fattore numerico per calcolare la nuova data di scadenza: ',
    'Month(s)' => 'Mese/i',
    'This task has been created by: ' => 'Questo compito è stato creato da: ',
    'Recurrent task has been generated:' => 'Il compito ricorrente è stato generato:',
    'Timeframe to calculate new due date: ' => 'Lasso temporale per calcolare la nuova data di scadenza: ',
    'Trigger to generate recurrent task: ' => 'Trigger per generare il compito ricorrente: ',
    'When task is closed' => 'Quando un compito è chiuso',
    'When task is moved from first column' => 'Quando un compito è spostato dalla prima colonna',
    'When task is moved to last column' => 'Quando un compito è spostato nell\'ultima colonna',
    'Year(s)' => 'Anno/i',
    ...
    'Date' => 'Data',
    'Add a comment log when moving the task between columns' => 'Aggiungi un log quando si sposta un compito tra colonne',
    'Move the task to another column when the category is changed' => 'Sposta il compito in un\'altra colonna quando la categoria viene modificata',
    'Send a task by email to someone' => 'Invia un compito via email a qualcuno',
    'Reopen a task' => 'Riapri un compito',
    'Notification' => 'Notifica',
    '%s moved the task #%d to the first swimlane' => '%s ha spostato il compito #%d nella prima corsia',
    'Swimlane' => 'Corsia',
    '%s moved the task %s to the first swimlane' => '%s ha spostato il compito %s nella prima corsia',
    '%s moved the task %s to the swimlane "%s"' => '%s ha spostato il compito %s nella corsia %s',
    'This report contains all subtasks information for the given date range.' => 'Questo report contiente tutte le informazioni sui sotto-compiti nell\'arco temporale indicato.',
    'This report contains all tasks information for the given date range.' => 'Questo report contiente tutte le informazioni sui compiti nell\'arco temporale indicato.',
    'Project activities for %s' => 'Attività di progetto per %s',
    'view the board on Kanboard' => 'guarda la bacheca su Kanboard',
    'The task has been moved to the first swimlane' => 'Il compito è stato spostato nella prima corsia',
    'The task has been moved to another swimlane:' => 'Il compito è stato spostato in un\'altra corsia:',
    'New title: %s' => 'Nuovo titolo: %s',
    'The task is not assigned anymore' => 'Il compito non è più assegnato a nessuno',
    ...
    'Do you really want to close the task "%s" as well as all subtasks?' => 'Vuoi veramente chiudere il compito "%s" e i relativi sotto-compiti?',
    'I want to receive notifications for:' => 'Voglio ricevere le notifiche per:',
    'All tasks' => 'Tutti i compiti',
    'Only for tasks assigned to me' => 'Solo per i compiti assegnati a me',
    'Only for tasks created by me' => 'Solo per i compiti creati da me',
    'Only for tasks created by me and tasks assigned to me' => 'Solo per i compiti creati da me o assegnati a me',
    '%%Y-%%m-%%d' => '%%Y-%%m-%%d',
    ...
    'Search tasks' => 'Ricerca compiti',
    'Reset filters' => 'Annulla filtri',
    'My tasks due tomorrow' => 'I miei compiti da completare per domani',
    ...
    'This chart shows the average time spent in each column for the last %d tasks.' => 'Questo grafico mostra il tempo medio trascorso in ogni colonna per gli ultimi %d compiti.',
    ...
    'This chart shows the average lead and cycle time for the last %d tasks over the time.' => 'Questo grafico mostra i tempi medi di consegna (Lead Time) e lavorazione (Cycle Time) per gli ultimi %d compiti.',
    ...
    'The lead time is the duration between the task creation and the completion.' => 'Il tempo di consegna (Lead Time) è la durata tra la creazione di un compito ed il suo completamento.',
    'The cycle time is the duration between the start date and the completion.' => 'Il tempo di lavorazione (Cycle Time) è la durata tra la data di inizio della lavorazione di un compito ed il suo completamento.',
    'If the task is not closed the current time is used instead of the completion date.' => 'Se il compito non è chiuso sarà usata la data attuale invece della data di completamento.',
    ...
    'Default task color' => 'Colore predefinito dei compiti',
    ...
    'Trigger automatically subtask time tracking' => 'Attiva automaticamente il time-tracking per i sotto-compiti',
    'Include closed tasks in the cumulative flow diagram' => 'Includi i compiti chiusi nel diagramma di flusso cumulativo',
    ...
    'End date:' => 'Data di fine:',
    'Change task color when using a specific task link' => 'Cambia colore del compito quando si un utilizza una determinata relazione di compito',
    'Task link creation or modification' => 'Creazione o modifica di relazione di compito',
    'Milestone' => 'Milestone',
    ...
    'Web' => 'Web',
    'New attachment on task #%d: %s' => 'Nuovo allegato nel compito #%d: %s',
    'New comment on task #%d' => 'Nuovo commento nel compito #%d',
    ...
    'New task #%d: %s' => 'Nuovo compito #%d: %s',
    'Task updated #%d' => 'Task #%d aggiornato',
    'Task #%d closed' => 'Task #%d chiuso',
    'Task #%d opened' => 'Task #%d aperto',
    'Column changed for task #%d' => 'Colonna modificata per il compito #%d',
    'New position for task #%d' => 'Nuova posizione per il compito #%d',
    'Swimlane changed for task #%d' => 'Corsia modificata per il compito #%d',
    'Assignee changed on task #%d' => 'Assegnatario modificato per il compito #%d',
    '%d overdue tasks' => '%d compiti scaduti',
    'Task #%d is overdue' => 'Il compito #%d è scaduto',
    'No notification.' => 'Nessuna nuova notifica.',
    'Mark all as read' => 'Segna tutti come letti',
    'Mark as read' => 'Segna come letto',
    'Total number of tasks in this column across all swimlanes' => 'Numero totale di compito in questa colonna per tutte le corsie',
    ...
    '%d task(s) have been imported successfully.' => '%d compito/i sono stati importati con successo.',
    ...
    '%s attached a file to the task #%d' => '%s ha allegato un file al compito #%d',
    ...
    'Tasks Importation' => 'Importazione compito',
    ...
    '%s attached a new file to the task %s' => '%s ha allegato un nuovo file al compito %s',
    ...
    'Assign the task to the person who does the action when the column is changed' => 'Assegna il compito alla persona che esegue l\'azione quando la colonna viene modificata',
    'Close a task in a specific column' => 'Chiudi un compito in una specifica colonna',
    ...
    'All tasks of the column "%s" and the swimlane "%s" have been closed successfully.' => 'Tutti i compiti della colonna "%s" e della corsia "%s" sono stati chiusi con successo.',
    'Do you really want to close all tasks of this column?' => 'Vuoi davvero chiudere tutti i compiti di questa colonna?',
    '%d task(s) in the column "%s" and the swimlane "%s" will be closed.' => '%d compito/i della colonna "%s" e della corsia "%s" saranno chiusi.',
    'Close all tasks in this column and this swimlane' => 'Chiudi tutti i compiti di questa colonna',
    ...
    'Close a task when there is no activity' => 'Chiudi un compito quando non c\'è nessuna attività',
    'Duration in days' => 'Durata in giorni',
    'Send email when there is no activity on a task' => 'Invia un\'email quando non c\'è attività sul compito',
    'Unable to fetch link information.' => 'Impossibile recuperare informazioni sul link.',
    'Daily background job for tasks' => 'Job giornaliero in background per i compiti',
    'Auto' => 'Automatico',
    'Related' => 'Correlato',
    'Attachment' => 'Allegato',
    ...
    'Change subtask position' => 'Cambia la posizione del sotto-compito',
    ...
    'Search by task status: ' => 'Ricerca per stato del compito: ',
    'Search by task title: ' => 'Ricerca per titolo del compito: ',
    ...
    'Open tasks assigned to "%s"' => 'Compiti aperti assegnati a "%s"',
    'Closed tasks assigned to "%s"' => 'Compiti chiusi assegnati a "%s"',
    ...
    'Subtask converted to task successfully.' => 'Sotto-compito converito in compito con successo.',
    'Unable to convert the subtask.' => 'Impossibile convertire il sotto-compito.',
    ...
    'Create tasks in bulk' => 'Creazione massiva di compiti',
    ...
    'Convert to task' => 'Converti in compito',
    'Convert sub-task to task' => 'Converti il sotto-compito in compito',
    'Do you really want to convert this sub-task to a task?' => 'Vuoi davvero convertire questo sotto-compito in un compito?',
    'My task title' => 'Titolo del mio compito',
    'Enter one task by line.' => 'Inserisci un compito per ogni riga.',
    ...
    'Close a task when there is no activity in a specific column' => 'Chiudi un compito quando non vi è alcuna attività in una specifica colonna',
    '%s removed a subtask for the task #%d' => '%s rimosso un sotto-compito per il compito #%d',
    '%s removed a comment on the task #%d' => '%s rimosso un commento nel compito #%d',
    'Comment removed on task #%d' => 'Commento rimosso nel compito #%d',
    'Subtask removed on task #%d' => 'Sotto-compito rimosso nel compito #%d',
    'Hide tasks in this column in the dashboard' => 'Nascondi i compiti in questa colonna nella dashboard',
    '%s removed a comment on the task %s' => '%s rimosso un commento nel compito %s',
    '%s removed a subtask for the task %s' => '%s rimosso un sotto-compito per il compito %s',
    'Comment removed' => 'Commento rimosso',
    'Subtask removed' => 'Sotto-compito rimosso',
    '%s set a new internal link for the task #%d' => '%s imposta un nuovo link interno per il compito #%d',
    ...
    '%s set a new internal link for the task %s' => '%s imposta un nuovo link interno per il compito %s',
    '%s removed an internal link for the task %s' => '%s rimosso un link interno per il compito %s',
    'Automatically set the due date on task creation' => 'Imposta automaticamente la data di scadenza alla creazione del compito',
    'Move the task to another column when closed' => 'Sposta il compito su un\'altra colonna quando viene chiuso',
    'Move the task to another column when not moved during a given period' => 'Sposta il compito su un\'altra colonna quando non viene spostato entro un certo periodo',
    'Dashboard for %s' => 'Dashboard per %s',
    'Tasks overview for %s' => 'Panoramica dei compiti per %s',
    'Subtasks overview for %s' => 'Panoramica dei compiti per %s',
    'Projects overview for %s' => 'Panoramica dei progetti per %s',
    'Activity stream for %s' => 'Flusso attività per %s',
    'Assign a color when the task is moved to a specific swimlane' => 'Assegna un colore quando il compito viene spostato su una specifica corsia',
    'Assign a priority when the task is moved to a specific swimlane' => 'Assegna una priorità quando il compito viene spostato su una specifica corsia',
    'User unlocked successfully.' => 'Utente sbloccato con successo.',
    'Unable to unlock the user.' => 'Impossibile sbloccare l\'utente.',
    'Move a task to another swimlane' => 'Sposta un compito su un\'altra corsia',
    'Creator Name' => 'Nome del creatore',
    'Time spent and estimated' => 'Tempo trascorso e stima',
    'Move position' => 'Cambia posizione',
    'Move task to another position on the board' => 'Sposta compito su un\'altra posizione nella board',
    'Insert before this task' => 'Inserisci prima di questo compito',
    'Insert after this task' => 'Inserisci dopo questo compito',
    ...
    'Only moving task between those columns is permitted' => 'È permesso solo muovere i compiti tra queste colonne',
    'Close a task in a specific column when not moved during a given period' => 'Chiudi un compito in una colonna specifica quando non viene mosso per un determinato periodo',
    ...
    'You cannot create tasks in this column.' => 'Non puoi creare dei compiti in questa colonna.',
    'Task creation is permitted for this column' => 'La creazione di compiti è permessa per questa colonna',
    'Closing or opening a task is permitted for this column' => 'Chiudere o aprire compito è permesso per questa colonna',
    'Task creation is blocked for this column' => 'La creazione di compiti è bloccata per questa colonna',
    'Closing or opening a task is blocked for this column' => 'Chiudere o aprire compito è bloccato per questa colonna',
    'Task creation is not permitted' => 'Creazione compito non permessa',
    'Closing or opening a task is not permitted' => 'Chiudere o aprire compito non è permesso',
    'New drag and drop restriction for the role "%s"' => 'Nuova restrizione "drag and drop" per la regola "%s"',
    'People belonging to this role will be able to move tasks only between the source and the destination column.' => 'Gli utenti che appartengono a questa regola saranno in grado di spostare i compiti solo tra la colonna di origine e quella di destinazione',
    ...
    'Moving a task is not permitted' => 'Spostare un compito non è permesso',
    'This value must be in the range %d to %d' => 'Questo valore deve essere compreso tra %d e %d',
    'You are not allowed to move this task.' => 'Non ti è permesso spostare questo compito.',
    ...
    'Public' => 'Pubblico',
    'Personal' => 'Privato',
    '%d tasks' => '%d dei compiti',
    '%d task' => '%d del compito',
    'Task ID' => 'ID del compito',
    ...
    '%d users' => '%d utenti',
    '%d user' => '%d utente',
    'Hide subtasks' => 'Nascondi sotto-compiti',
    'Show subtasks' => 'Mostra sotto-compiti',
    ...
    'You are not allowed to update tasks assigned to someone else.' => 'Non sei abilitato ad aggiornare i compiti assegnati a qualcun altro.',
    'You are not allowed to change the assignee.' => 'Non sei abilitato a modificare l\'assegnatario',
    'Task suppression is not permitted' => 'L\'eliminazione del compito non è permessa',
    'Changing assignee is not permitted' => 'Non è permesso modificare l\'assegnatario',
    'Update only assigned tasks is permitted' => 'E\' permesso aggiornare solo i compiti assegnati',
    'Only for tasks assigned to the current user' => 'Solo per i compiti assegnati all\'utente corrente',
    ...
    '%d subtasks' => '%d sotto-compiti',
    '%d subtask' => '%d sotto-compiti',
    'Only moving task between those columns is permitted for tasks assigned to the current user' => 'I compiti assegnati all\'utente corrente possono essere solo spostati in quelle colonne',
    '[DUPLICATE]' => '[DUPLICA]',
    'DKK - Danish Krona' => 'DKK - Corona Danese',
    'Remove user from group' => 'Rimuovi utente dal gruppo',
    'Assign the task to its creator' => 'Assegna il compito al suo creatore',
    'This task was sent by email to "%s" with subject "%s".' => 'Questo compito è stato inviato per email a "%s" con oggetto "%s".',
    ...
    'Add a new Kanboard task' => 'Crea un nuovo compito Kanboard',
    'Subtask not started' => 'Sotto-compito non iniziato',
    'Subtask currently in progress' => 'Sotto-compito attualmente in corso',
    'Subtask completed' => 'Sotto-compito completato',
    'Subtask added successfully.' => 'Sotto-compito aggiunto con successo.',
    '%d subtasks added successfully.' => '%d sotto-compiti aggiunti con successo.',
    'Enter one subtask by line.' => 'Inserisci un sotto-compito per riga.',
    'Predefined Contents' => 'Contenuti Predefiniti',
    'Predefined contents' => 'Contenuti predefiniti',
    'Predefined Task Description' => 'Descrizione predefinita del compito',
    'Do you really want to remove this template? "%s"' => 'Vuoi eliminare veramente questo template? "%s"',
    'Add predefined task description' => 'Aggiungi una descrizione predefinita del compito',
    'Predefined Task Descriptions' => 'Descrizioni predefinite dei compito',
    ...
    'Template for the task description' => 'Template per la descrizione del compito',
    ...
    'Only the task title is required' => 'Solo il titolo del compito è obbligatorio',
    ...
    'Stop the timer of all subtasks when moving a task to another column' => 'Interrompi il timer di tutti i sotto-compiti quando un compito viene spostato in un\'altra colonna',
    'Subtask Title' => 'Titolo del sotto-compito',
    'Add a subtask and activate the timer when moving a task to another column' => 'Aggiungi un sotto-compito e attiva il timer quando un compito viene spostato in un\'altra colonna',
    'days' => 'giorni',
    'minutes' => 'minuti',
    'seconds' => 'secondi',
    ...
    'Move the task to another column once a predefined start date is reached' => 'Sposta il compito in un\'altra colonna quando si raggiunge una data predefinita',
    'This task is now linked to the task %s with the relation "%s"' => 'Questo compito è ora collegato al compito %s tramite la relazione "%s"',
    'The link with the relation "%s" to the task %s has been removed' => 'Il collegamento con la relazione "%s" al compito %s è stato rimosso',
    ...
    '%s moved the task #%d to the position %d in the column "%s"' => '%s ha spostato il compito #%d a posizione %d nella colonna "%s"',
    '%s moved the task #%d to the swimlane "%s"' => '%s ha spostato il compito #%d nella corsia "%s"',
    '%sh spent' => '%sh effettive',
    '%sh estimated' => '%sh stimate',
    'Select All' => 'Seleziona tutti',
    'Unselect All' => 'Deseleziona tutti',
    'Apply action' => 'Applica azione',
    'Move selected tasks to another column or swimlane' => 'Sposta i compiti selezionati in un\'altra colonna',
    'Edit tasks in bulk' => 'Modifica i compiti massivamente',
    'Choose the properties that you would like to change for the selected tasks.' => 'Scegli le proprietà che vorresti modificare per i compiti selezionato.',
    'Configure this project' => 'Configura questo progetto',
    'Start now' => 'Inizia ora',
    '%s removed a file from the task #%d' => '%s ha rimosso un file dal compito #%d',
    'Attachment removed from task #%d: %s' => 'Allegato rimosso dal compito #%d: %s',
    'No color' => 'Nessun colore',
    'Attachment removed "%s"' => 'Allegato rimosso "%s"',
    '%s removed a file from the task %s' => '%s ha rimosso un file dal compito %s',
    'Move the task to another swimlane when assigned to a user' => 'Sposta il compito in un\'altra corsia quando viene assegnato ad un utente',
    'Destination swimlane' => 'Corsia di destinazione',
    'Assign a category when the task is moved to a specific swimlane' => 'Assegna una categoria quando il compito viene spostato in una corsia specifica',
    'Move the task to another swimlane when the category is changed' => 'Sposta il compito in un\'altra corsia quando la categoria viene modificata',
    ...
    'Reorder this column by id (ASC)' => 'Riordina questa colonna per ID (ASC)',
    'Reorder this column by id (DESC)' => 'Riordina questa colonna per ID (DESC)',
    ...
    'Automatically update the start date when the task is moved away from a specific column' => 'Aggiorna automaticamente la data di inizio quando il compito è tolto da una colonna specifica',
    'HTTP Client:' => 'Client HTTP',
    'Assigned' => 'Assegnato',
    'Task limits apply to each swimlane individually' => 'I limiti di compito si applicano individualmente ad ogni corsia',
    'Column task limits apply to each swimlane individually' => 'I limiti di compito per colonna si applicano individualmente ad ogni corsia',
    'Column task limits are applied to each swimlane individually' => 'I limiti di compito per colonna vengono applicati individualmente ad ogni corsia',
    'Column task limits are applied across swimlanes' => 'I limiti di compito per colonna vengono applicati a tutte le corsie',
    'Task limit: ' => 'Limite di compito',
    'Change to global tag' => 'Modifica all\'etichetta globale',
    'Do you really want to make the tag "%s" global?' => 'Vuoi davvero rendere globale l\'etichetta "%s"?',
    'Enable global tags for this project' => 'Abilita le etichette globali per questo progetto',
    'Group membership(s):' => 'Assegnazioni di gruppo',
    '%s is a member of the following group(s): %s' => '%s è membro dei gruppi seguenti: %s',
    '%d/%d group(s) shown' => '%d/%d gruppi mostrati',
    'Subtask creation or modification' => 'Creazione o modifica sotto-compiti',
    'Assign the task to a specific user when the task is moved to a specific swimlane' => 'Assegna il compito ad un utente specifico quando il compito viene spostato ad una corsia specifica',
    'Comment' => 'Commento',
    'Collapse vertically' => 'Riduci verticalmente',
    'Expand vertically' => 'Espandi verticalmente',
    'MXN - Mexican Peso' => 'MXN - Peso messicano',
    'Estimated vs actual time per column' => 'Tempo stimato vs reale per colonna',
    'HUF - Hungarian Forint' => 'HUF - Fiorino ungherese',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => 'Devi selezionare un file da caricare come avatar!',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'Il file caricato non è un\'immagine valida! (Sono consentiti solo *.gif, *.jpg, *.jpeg e *.png!)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Imposta automaticamente la data di scadenza quando il task viene spostato da una colonna specifica',
    'No other projects found.' => 'Nessun altro progetto trovato.',
    'Tasks copied successfully.' => 'Attività copiate con successo.',
    'Unable to copy tasks.' => 'Impossibile copiare le attività.',
    'Theme' => 'Tema',
    'Theme:' => 'Tema:',
    'Light theme' => 'Tema chiaro',
    'Dark theme' => 'Tema scuro',
    'Automatic theme - Sync with system' => 'Tema automatico - Sincronizza con il sistema',
    'Application managers or more' => 'Gestori dell\'applicazione o più',
    'Administrators' => 'Amministratori',
    'Visibility:' => 'Visibilità:',
    'Standard users' => 'Utenti standard',
    'Visibility is required' => 'La visibilità è obbligatoria',
    'The visibility should be an app role' => 'La visibilità deve essere un ruolo dell\'applicazione',
    'Reply' => 'Rispondi',
    '%s wrote: ' => '%s ha scritto: ',
    'Number of visible tasks in this column and swimlane' => 'Numero di attività visibili in questa colonna e swimlane',
    'Number of tasks in this swimlane' => 'Numero di attività in questa swimlane',
    'Unable to find another subtask in progress, you can close this window.' => 'Impossibile trovare un\'altra sotto-attività in corso, puoi chiudere questa finestra.',
    'This theme is invalid' => 'Questo tema non è valido',
    'This role is invalid' => 'Questo ruolo non è valido',
    'This timezone is invalid' => 'Questo fuso orario non è valido',
    'This language is invalid' => 'Questa lingua non è valida',
    'This URL is invalid' => 'Questo URL non è valido',
    'Date format invalid' => 'Formato data non valido',
    'Time format invalid' => 'Formato ora non valido',
    'Invalid Mail transport' => 'Trasporto email non valido',
    'Color invalid' => 'Colore non valido',
    'This value must be greater or equal to %d' => 'Questo valore deve essere maggiore o uguale a %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Aggiungi un BOM all\'inizio del file (richiesto per Microsoft Excel)',
    'Just add these tag(s)' => 'Aggiungi solo queste etichette',
    'Remove internal link(s)' => 'Rimuovi i collegamenti interni',
    'Import tasks from another project' => 'Importa attività da un altro progetto',
    'Select the project to copy tasks from' => 'Seleziona il progetto da cui copiare le attività',
