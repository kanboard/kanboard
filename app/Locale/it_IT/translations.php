...
return array(
    ...
    'Only moving task between those columns is permitted' => 'E\' consentito spostare il task solo tra queste colonne',
    'Close a task in a specific column when not moved during a given period' => 'Chiudi un task in una specifica colonna se non viene mosso per un certo periodo',
    'Edit columns' => 'Modifica colonne',
    'The column restriction has been created successfully.' => 'La limitazione della colonna è stata creata con successo.',
    'Unable to create this column restriction.' => 'Impossibile creare questa limitazione della colonna.',
    'Column restriction removed successfully.' => 'Limitazione della colonna rimossa con successo.',
    'Unable to remove this restriction.' => 'Impossibile rimuovere questa limitazione.',
    'Your custom project role has been created successfully.' => 'Il tuo ruolo personalizzato per il progetto è stato creato con successo.',
    'Unable to create custom project role.' => 'Impossibile creare ruolo personalizzato per il progetto.',
    'Your custom project role has been updated successfully.' => 'Il tuo ruolo personalizzato per il progetto è stato aggiornato con successo.',
    'Unable to update custom project role.' => 'Impossibile aggiornare il ruolo personalizzato per il progetto.',
    'Custom project role removed successfully.' => 'Ruolo personalizzato per il progetto rimosso con successo.',
    'Unable to remove this project role.' => 'Impossibile rimuovere questo ruolo personalizzato per il progetto.',
    'The project restriction has been created successfully.' => 'La limitazione per il progetto è stata creata con successo.',
    'Unable to create this project restriction.' => 'Impossibile creare questa limitazione per il progetto',
    'Project restriction removed successfully.' => 'Limitazione del progetto rimossa con successo.',
    'You cannot create tasks in this column.' => 'Non è possibile creare tasks in questa colonna.',
    'Task creation is permitted for this column' => 'Creazione dei task permessa per questa colonna',
    'Closing or opening a task is permitted for this column' => 'Chiudere o aprire un task è permesso per questa colonna',
    'Task creation is blocked for this column' => 'Creazione task bloccata per questa colonna',
    'Closing or opening a task is blocked for this column' => 'Chiudere o aprire un task non è permesso per questa colonna',
    'Task creation is not permitted' => 'Creazione task non permessa',
    'Closing or opening a task is not permitted' => 'Chiudere o aprire un task non è permesso',
    'New drag and drop restriction for the role "%s"' => 'Nuova limitazione sul drag and drop per il ruolo "%s"',
    'People belonging to this role will be able to move tasks only between the source and the destination column.' => 'Le persone che hanno questo ruolo possono spostare i tasks solo tra la colonna sorgente e quella destinazione.',
    'Remove a column restriction' => 'Rimuovi una limitazione di colonna',
    'Do you really want to remove this column restriction: "%s" to "%s"?' => 'Vuoi veramente rimuovere questa limitazione di colonna: "%s" a "%s"?',
    'New column restriction for the role "%s"' => 'Nuova limitazione di colonna per il ruolo "%s"',
    'Rule' => 'Regola',
    'Do you really want to remove this column restriction?' => 'Vuoi veramente rimuovere questa limitazione di colonna?',
    'Custom roles' => 'Ruoli personalizzati',
    'New custom project role' => 'Nuovo ruolo personalizzato per il progetto',
    'Edit custom project role' => 'Modifica ruolo personalizzato per il progetto',
    'Remove a custom role' => 'Rimuovi un ruolo personalizzato',
    'Do you really want to remove this custom role: "%s"? All people assigned to this role will become project member.' => 'Vuoi rimuovere veramente questo ruolo personalizzato "%s"? Tutti gli utenti assegnati a questo ruolo diventeranno membri del progetto.',
    'There is no custom role for this project.' => 'Non ci sono ruoli personalizzati per questo progetto.',
    'New project restriction for the role "%s"' => 'Nuova limitazione di progetto per il ruolo "%s"',
    'Restriction' => 'Limitazione',
    'Remove a project restriction' => 'Rimuovi una limitazione sul progetto',
    'Do you really want to remove this project restriction: "%s"?' => 'Vuoi rimuovere veramente questa limitazione sul progetto: "%s"?',
    'Duplicate to multiple projects' => 'Duplica su più progetti',
    'This field is required' => 'Questo campo è obbligatorio',
    'Moving a task is not permitted' => 'Non è consentito spostare un task',
    'This value must be in the range %d to %d' => 'Questo valore dev\'essere compreso tra %d e %d',
    'You are not allowed to move this task.' => 'Non hai i permessi per spostare questo task.',
);
