...
return array(
    ...
    'Status is open' => 'Η κατάσταση είναι "ανοικτά"',
    'Status is closed' => 'Η κατάσταση είναι "κλειστά"',
    ...
    'Completed on %B %e, %Y at %k:%M %p' => 'Ολοκληρώθηκε στις %d/%m/%Y και ώρα %H:%M',
    ...
    'Add' => 'Προσθήκη',
    'Estimated time: %s hours' => 'Εκτιμώμενος χρόνος: %s ώρες',
    'Time spent: %s hours' => 'Χρόνος  που δαπανήθηκε : %s ώρες',
    'Started on %B %e, %Y' => 'Άρχισε την %d/%m/%Y',
    'Start date' => 'Ημερομηνία έναρξης',
    ...
    'Expand sidebar' => 'Διαστολή sidebar',
