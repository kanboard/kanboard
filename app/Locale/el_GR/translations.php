...
return array(
    ...
    'Example: http://example.kanboard.net/ (used by email notifications)' => 'Παράδειγμα: http://exemple.kanboard.net/ (χρησιμοποιείται για ειδοποιήσεις μέσω email)',
    ...
    'Do you really want to close the task "%s" as well as all subtasks?' => 'Σίγουρα θέλετε να κλείσετε την εργασία « %s » και όλες τις υπο-εργασίες της (αν υπάρχουν)?',
