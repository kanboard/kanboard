...
return array(
    ...
    'Enable email notifications' => '启用email通知',
    'Task position:' => '任务位置：',
    ...
    'Email sender address' => 'email发送地址',
    'Email transport' => 'email转发',
    ...
    'Invite people' => '邀请新用户',
    'Emails' => 'Emails',
    'Enter one email address by line.' => '输入email地址，每行一个。',
    ...
    'The project email is optional and could be used by several plugins.' => '项目email地址可选，适用于插件。',
    'The project email must be unique across all projects' => '项目email地址必须全局唯一',
    'The email configuration has been disabled by the administrator.' => 'email配置被管理员禁用。',
