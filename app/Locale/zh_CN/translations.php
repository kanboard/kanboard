...
return [
    ...
    'Reorder this column by id (ASC)' => '按ID重新排序此列 (升序)',
    'Reorder this column by id (DESC)' => '按ID重新排序此列 (降序)',
    ...
    'Light theme' => '浅色主题',
    'Dark theme' => '深色主题',
    'Automatic theme - Sync with system' => '自动主题 - 同步系统设置',
    'Application managers or more' => '应用程序经理或更多',
    'Administrators' => '管理员',
    'Visibility:' => '可见性:',
    'Standard users' => '标准用户',
    'Visibility is required' => '可见性是必需的',
    'The visibility should be an app role' => '可见性应为应用角色',
    'Reply' => '回复',
    '%s wrote: ' => '%s 写道：',
    'Number of visible tasks in this column and swimlane' => '此列和泳道中可见任务的数量',
    'Number of tasks in this swimlane' => '此泳道中的任务数',
    'Unable to find another subtask in progress, you can close this window.' => '找不到另一个正在进行的子任务，您可以关闭此窗口。',
    'This theme is invalid' => '此主题无效',
    'This role is invalid' => '此角色无效',
    'This timezone is invalid' => '此时区无效',
    'This language is invalid' => '此语言无效',
    'This URL is invalid' => '此URL无效',
    'Date format invalid' => '日期格式无效',
    'Time format invalid' => '时间格式无效',
    'Invalid Mail transport' => '无效的邮件传输',
    'Color invalid' => '颜色无效',
    'This value must be greater or equal to %d' => '此值必须大于或等于 %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => '在文件开头添加 BOM（Microsoft Excel 需要）',
    'Just add these tag(s)' => '只需添加这些标签',
    'Remove internal link(s)' => '移除内部链接',
    'Import tasks from another project' => '从其他项目导入任务',
    'Select the project to copy tasks from' => '选择要从中复制任务的项目',
