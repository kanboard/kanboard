...
return [
    ...
    'I only want to receive notifications for these projects:' => 'Vull rebre notificacions només per a aquells projectes:',
    ...
    'This QR code contains the key URI: ' => 'Aquest codi QR conté la URI de la clau: ',
    ...
    'Do you really want to disable the two factor authentication for this user: "%s"?' => 'Realment vols desactivar l\'autenticació de doble factor per a aquest usuari: "%s"?',
    ...
    'This linked task id doesn\'t exists' => 'Aquest ID de tasca enllaçada no existeix',
    ...
    'Timeframe to calculate new due date: ' => 'Període de temps per calcular la nova data de venciment: ',
    'Trigger to generate recurrent task: ' => 'Activador per generar tasques recurrents: ',
    ...
    '%s moved the task %s to the swimlane "%s"' => '%s va moure la tasca %s al carril "%s"',
    ...
    'Time spent changed: %sh' => 'Temps invertit canviat: %sh',
    'Time estimated changed: %sh' => 'Temps estimat canviat: %sh',
    'The field "%s" has been updated' => 'El camp "%s" ha estat actualitzat',
    ...
    'Remove user from group "%s"' => 'Eliminar usuari del grup "%s"',
    ...
    'Do you really want to remove the user "%s" from the group "%s"?' => 'Realment vols eliminar l\'usuari "%s" del grup "%s"?',
    'There is no group.' => 'No hi ha cap grup.',
    'Add group member' => 'Afegeix membre del grup',
    'Do you really want to remove this group: "%s"?' => 'Realment vols eliminar aquest grup: "%s"?',
    ...
    'Two-Factor Provider: ' => 'Proveïdor de doble factor: ',
    ...
    'All tasks of the column "%s" and the swimlane "%s" have been closed successfully.' => 'Totes les tasques de la columna "%s" i del carril "%s" s\'han tancat correctament.',
    'Do you really want to close all tasks of this column?' => 'Vols tancar totes les tasques d\'aquesta columna?',
    '%d task(s) in the column "%s" and the swimlane "%s" will be closed.' => '%d tasca(es) a la columna "%s" i al carril "%s" es tancarà(n).',
    ...
    'Do you really want to remove this custom filter: "%s"?' => 'Realment vols eliminar aquest filtre personalitzat: "%s"?',
    ...
    'The maximum allowed file size is %sB.' => 'La mida màxima de fitxer permesa és %sB.',
    ...
    'Do you really want to disable this user: "%s"?' => 'Realment vols desactivar aquest usuari: "%s"?',
    'Enable user' => 'Permetre a l\'usuari',
    'Do you really want to enable this user: "%s"?' => 'Realment vols habilitar aquest usuari: "%s"?',
    ...
    'Your board doesn\'t have any columns!' => 'El teu tauler no té columnes!',
    ...
    'Search by creator: ' => 'Cerca per creador: ',
    ...
    'Projects where "%s" is manager' => 'Projectes on "%s" és gestor',
    'Projects where "%s" is member' => 'Projectes on "%s" és membre',
    'Open tasks assigned to "%s"' => 'Tasques obertes assignades a "%s"',
    'Closed tasks assigned to "%s"' => 'Tasques tancades assignades a "%s"',
    'Assign automatically a color based on a priority' => 'Assignar automàticament un color basat en una prioritat',
    'Overdue tasks for the project(s) "%s"' => 'Tasques endarrerides per al(s) projecte(s) "%s"',
    ...
    'You don\'t have the permission to remove this plugin.' => 'No tens permís per eliminar aquest connector.',
    ...
    'Do you really want to remove this plugin: "%s"?' => 'Realment vols eliminar aquest connector: "%s"?',
    'Uninstall' => 'Suprimeix',
    'Listing' => 'Llistat',
    'Metadata' => 'Metadades',
    ...
    'Do you really want to remove this tag: "%s"?' => 'Realment vols eliminar aquesta etiqueta: "%s"?',
    ...
    'New drag and drop restriction for the role "%s"' => 'Nova restricció d\'arrossegar i deixar anar per al rol "%s"',
    ...
    'Do you really want to remove this column restriction: "%s" to "%s"?' => 'Realment vols eliminar aquesta restricció de columna: "%s" a "%s"?',
    'New column restriction for the role "%s"' => 'Nova restricció de columna per al rol "%s"',
    'Rule' => 'regla',
    ...
    'Do you really want to remove this custom role: "%s"? All people assigned to this role will become project member.' => 'Realment vols eliminar aquest rol personalitzat: "%s"? Totes les persones assignades a aquest rol es convertiran en membres del projecte.',
    'There is no custom role for this project.' => 'No hi ha una funció personalitzada per a aquest projecte.',
    'New project restriction for the role "%s"' => 'Nova restricció de projecte per al rol "%s"',
    'Restriction' => 'Restricció',
    'Remove a project restriction' => 'Eliminar una restricció projecte',
    'Do you really want to remove this project restriction: "%s"?' => 'Realment vols eliminar aquesta restricció de projecte: "%s"?',
    ...
    'Your personal API access token is "%s"' => 'La teva clau d\'accés API personal és "%s"',
    'Remove your token' => 'Traieu el testimoni',
    'Generate a new token' => 'Generar un nou token',
    'Showing %d-%d of %d' => 'Mostrant %d-%d de %d',
    ...
    'Do you really want to close this project: "%s"?' => 'Realment vols tancar aquest projecte: "%s"?',
    'Reopen a project' => 'Torna a obrir un projecte',
    'Do you really want to reopen this project: "%s"?' => 'Realment vols reobrir aquest projecte: "%s"?',
    ...
    'Sent by email to "%s" (%s)' => 'Enviat per correu electrònic a "%s" (%s)',
    ...
    'Automatic action not found: "%s"' => 'Acció automàtica no trobada: "%s"',
    ...
    'Remove user from group' => 'Eliminar usuari del grup',
    'Assign the task to its creator' => 'Assignar la tasca al seu creador',
    'This task was sent by email to "%s" with subject "%s".' => 'Aquesta tasca s\'ha enviat per correu electrònic a "%s" amb l\'assumpte "%s".',
    'Predefined Email Subjects' => 'Assumptes de correu electrònic predefinits',
    'Write one subject by line.' => 'Escriu un assumpte per línia.',
    'Create another link' => 'Crear un altre enllaç',
    'BRL - Brazilian Real' => 'BRL - Real Brasiler',
    'Add a new Kanboard task' => 'Afegir una nova tasca de Kanboard',
    'Subtask not started' => 'Subtasca no iniciada',
    'Subtask currently in progress' => 'Subtasca actualment en curs',
    'Subtask completed' => 'Subtasca completada',
    'Subtask added successfully.' => 'Subtasca afegida correctament.',
    '%d subtasks added successfully.' => '%d subtasques afegides correctament.',
    'Enter one subtask by line.' => 'Introdueix una subtasca per línia.',
    'Predefined Contents' => 'Continguts predefinits',
    'Predefined contents' => 'Continguts predefinits',
    'Predefined Task Description' => 'Descripció de la tasca predefinida',
    'Do you really want to remove this template? "%s"' => 'Realment vols eliminar aquesta plantilla? "%s"',
    'Add predefined task description' => 'Afegir descripció de tasca predefinida',
    'Predefined Task Descriptions' => 'Descripcions de tasques predefinides',
    'Template created successfully.' => 'Plantilla creada correctament.',
    'Unable to create this template.' => 'No s\'ha pogut crear aquesta plantilla.',
    'Template updated successfully.' => 'Plantilla actualitzada correctament.',
    'Unable to update this template.' => 'No s\'ha pogut actualitzar aquesta plantilla.',
    'Template removed successfully.' => 'Plantilla eliminada correctament.',
    'Unable to remove this template.' => 'No s\'ha pogut eliminar aquesta plantilla.',
    'Template for the task description' => 'Plantilla per a la descripció de la tasca',
    'The start date is greater than the end date' => 'La data d\'inici és posterior a la data de finalització',
    'Tags must be separated by a comma' => 'Les etiquetes s\'han de separar per una coma',
    'Only the task title is required' => 'Només el títol de la tasca és obligatori',
    'Creator Username' => 'Nom d\'usuari del creador',
    'Color Name' => 'Nom del color',
    'Column Name' => 'Nom de la columna',
    'Swimlane Name' => 'Nom del carril',
    'Time Estimated' => 'Temps estimat',
    'Time Spent' => 'Temps dedicat',
    'External Link' => 'Enllaç extern',
    'This feature enables the iCal feed, RSS feed and the public board view.' => 'Aquesta funció habilita el canal iCal, el canal RSS i la vista pública del tauler.',
    'Stop the timer of all subtasks when moving a task to another column' => 'Atura el temporitzador de totes les subtasques quan es mou una tasca a una altra columna',
    'Subtask Title' => 'Títol de la subtasca',
    'Add a subtask and activate the timer when moving a task to another column' => 'Afegir una subtasca i activar el temporitzador quan es mou una tasca a una altra columna',
    'days' => 'dies',
    'minutes' => 'minuts',
    'seconds' => 'segons',
    'Assign automatically a color when preset start date is reached' => 'Assigna automàticament un color quan s\'arriba a la data d\'inici preestablerta',
    'Move the task to another column once a predefined start date is reached' => 'Mou la tasca a una altra columna un cop s\'arriba a una data d\'inici predefinida',
    'This task is now linked to the task %s with the relation "%s"' => 'Aquesta tasca ara està enllaçada a la tasca %s amb la relació "%s"',
    'The link with the relation "%s" to the task %s has been removed' => 'S\'ha eliminat l\'enllaç amb la relació "%s" a la tasca %s',
    'Custom Filter:' => 'Filtre personalitzat:',
    'Unable to find this group.' => 'No s\'ha pogut trobar aquest grup.',
    '%s moved the task #%d to the column "%s"' => '%s va moure la tasca #%d a la columna "%s"',
    '%s moved the task #%d to the position %d in the column "%s"' => '%s va moure la tasca #%d a la posició %d de la columna "%s"',
    '%s moved the task #%d to the swimlane "%s"' => '%s va moure la tasca #%d al carril "%s"',
    '%sh spent' => '%sh dedicades',
    '%sh estimated' => '%sh estimades',
    'Select All' => 'Seleccionar tot',
    'Unselect All' => 'Deseleccionar tot',
    'Apply action' => 'Aplicar acció',
    'Move selected tasks to another column or swimlane' => 'Mou les tasques seleccionades a una altra columna o carril',
    'Edit tasks in bulk' => 'Edita tasques en massa',
    'Choose the properties that you would like to change for the selected tasks.' => 'Trieu les propietats que voleu canviar per a les tasques seleccionades.',
    'Configure this project' => 'Configura aquest projecte',
    'Start now' => 'Comença ara',
    '%s removed a file from the task #%d' => '%s ha eliminat un fitxer de la tasca #%d',
    'Attachment removed from task #%d: %s' => 'Adjunt eliminat de la tasca #%d: %s',
    'No color' => 'Sense color',
    'Attachment removed "%s"' => 'Adjunt eliminat "%s"',
    '%s removed a file from the task %s' => '%s ha eliminat un fitxer de la tasca %s',
    'Move the task to another swimlane when assigned to a user' => 'Mou la tasca a un altre carril quan se l\'assigna a un usuari',
    'Destination swimlane' => 'Carril de destí',
    'Assign a category when the task is moved to a specific swimlane' => 'Assigna una categoria quan la tasca es mou a un carril específic',
    'Move the task to another swimlane when the category is changed' => 'Mou la tasca a un altre carril quan es canvia la categoria',
    'Reorder this column by priority (ASC)' => 'Reordena aquesta columna per prioritat (ASC)',
    'Reorder this column by priority (DESC)' => 'Reordena aquesta columna per prioritat (DESC)',
    'Reorder this column by assignee and priority (ASC)' => 'Reordena aquesta columna per assignat i prioritat (ASC)',
    'Reorder this column by assignee and priority (DESC)' => 'Reordena aquesta columna per assignat i prioritat (DESC)',
    'Reorder this column by assignee (A-Z)' => 'Reordena aquesta columna per assignat (A-Z)',
    'Reorder this column by assignee (Z-A)' => 'Reordena aquesta columna per assignat (Z-A)',
    'Reorder this column by due date (ASC)' => 'Reordena aquesta columna per data de venciment (ASC)',
    'Reorder this column by due date (DESC)' => 'Reordena aquesta columna per data de venciment (DESC)',
    'Reorder this column by id (ASC)' => 'Reordena aquesta columna per id (ASC)',
    'Reorder this column by id (DESC)' => 'Reordena aquesta columna per id (DESC)',
    ...
    'Move the task to another column when the due date is less than a certain number of days' => 'Mou la tasca a una altra columna quan la data de venciment sigui inferior a un cert nombre de dies',
    'Automatically update the start date when the task is moved away from a specific column' => 'Actualitza automàticament la data d\'inici quan la tasca es mou fora d\'una columna específica',
    'HTTP Client:' => 'Client HTTP:',
    'Assigned' => 'Assignat',
    'Task limits apply to each swimlane individually' => 'Els límits de tasques s\'apliquen a cada carril individualment',
    'Column task limits apply to each swimlane individually' => 'Els límits de tasques de columna s\'apliquen a cada carril individualment',
    'Column task limits are applied to each swimlane individually' => 'Els límits de tasques de columna s\'apliquen a cada carril individualment',
    'Column task limits are applied across swimlanes' => 'Els límits de tasques de columna s\'apliquen a tots els carrils',
    'Task limit: ' => 'Límit de tasques:',
    'Change to global tag' => 'Canvia a etiqueta global',
    'Do you really want to make the tag "%s" global?' => 'Realment vols que l\'etiqueta "%s" sigui global?',
    'Enable global tags for this project' => 'Habilita etiquetes globals per a aquest projecte',
    'Group membership(s):' => 'Membre(s) del grup:',
    '%s is a member of the following group(s): %s' => '%s és membre del(s) següent(s) grup(s): %s',
    '%d/%d group(s) shown' => '%d/%d grup(s) mostrat(s)',
    'Subtask creation or modification' => 'Creació o modificació de subtasques',
    'Assign the task to a specific user when the task is moved to a specific swimlane' => 'Assigna la tasca a un usuari concret quan es mou a un carril específic',
    'Comment' => 'Comentari',
    'Collapse vertically' => 'Replega verticalment',
    'Expand vertically' => 'Expandeix verticalment',
    'MXN - Mexican Peso' => 'MXN - Peso Mexicà',
    'Estimated vs actual time per column' => 'Temps estimat vs temps real per columna',
    'HUF - Hungarian Forint' => 'HUF - Fòrint Hongarès',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => 'Has de seleccionar un fitxer per pujar com a avatar!',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'El fitxer que has pujat no és una imatge vàlida! (Només es permeten *.gif, *.jpg, *.jpeg i *.png!)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Estableix automàticament la data de venciment quan la tasca es mou fora d\'una columna específica',
    'No other projects found.' => 'No s\'han trobat altres projectes.',
    'Tasks copied successfully.' => 'Tasques copiades correctament.',
    'Unable to copy tasks.' => 'No s\'han pogut copiar les tasques.',
    'Theme' => 'Tema',
    'Theme:' => 'Tema:',
    'Light theme' => 'Tema clar',
    'Dark theme' => 'Tema fosc',
    'Automatic theme - Sync with system' => 'Tema automàtic - Sincronitza amb el sistema',
    'Application managers or more' => 'Gestors d\'aplicació o més',
    'Administrators' => 'Administradors',
    'Visibility:' => 'Visibilitat:',
    'Standard users' => 'Usuaris estàndard',
    'Visibility is required' => 'La visibilitat és obligatòria',
    'The visibility should be an app role' => 'La visibilitat hauria de ser una funció de l\'aplicació',
    'Reply' => 'Respondre',
    '%s wrote: ' => '%s va escriure: ',
    'Number of visible tasks in this column and swimlane' => 'Nombre de tasques visibles en aquesta columna i carril',
    'Number of tasks in this swimlane' => 'Nombre de tasques en aquest carril',
    'Unable to find another subtask in progress, you can close this window.' => 'No es pot trobar una altra subtasca en curs, podeu tancar aquesta finestra.',
    'This theme is invalid' => 'Aquest tema no és vàlid',
    'This role is invalid' => 'Aquest rol no és vàlid',
    'This timezone is invalid' => 'Aquesta zona horària no és vàlida',
    'This language is invalid' => 'Aquesta llengua no és vàlida',
    'This URL is invalid' => 'Aquesta URL no és vàlida',
    'Date format invalid' => 'Format de data no vàlid',
    'Time format invalid' => 'Format d\'hora no vàlid',
    'Invalid Mail transport' => 'Transport de correu no vàlid',
    'Color invalid' => 'Color no vàlid',
    'This value must be greater or equal to %d' => 'Aquest valor ha de ser major o igual que %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Afegeix un BOM al principi del fitxer (requerit per a Microsoft Excel)',
    'Just add these tag(s)' => 'Només afegeix aquestes etiqueta(es)',
    'Remove internal link(s)' => 'Eliminar enllaç(os) intern(s)',
    'Import tasks from another project' => 'Importa tasques d\'un altre projecte',
    'Select the project to copy tasks from' => 'Selecciona el projecte del qual copiar les tasques',
    ...
    'Assign the task to its creator for specific columns if no assignee is set manually' => 'Assigna la tasca al seu creador per a columnes específiques si no s\'ha definit cap responsable manualment',
    'Assign a task to the logged user on column change to specified column if no user is assigned' => 'Assigna una tasca a l\'usuari connectat en canviar de columna a la columna especificada si no hi ha cap usuari assignat',
];
