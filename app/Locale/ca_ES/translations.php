...
'Task assignee change'=> 'Tasca de canvi del cessionari',
'%s changed the assignee of the task #%d to %s '=> '%s va canviar el cessionari de la tasca #%d de %s ',
'%s changed the assignee of the task %s to %s '=> '%s va canviar el cessionari de la tasca %s %s ',
...
'Change the assignee based on an external username'=> 'Canviar el cessionari basat en un nom d\'usuari extern',
...
'Move the task to another column when assignee is cleared'=> 'Moure la tasca a una altra columna quan s\'esborra cessionari',
...
'%s removed the assignee of the task %s '=> '%s remogut el cessionari de la tasca %s ',
...
'New assignee: %s '=> 'Nova cessionari:%s ',
...
'Assignee changed on task #%d '=> 'Cessionari va canviar en la tasca #%d ',
...
'Assignee Username'=> 'Nom d\'usuari cessionari',
'Assignee Name'=> 'nom cessionari',
'Groups'=> 'grups',
...
'Subtasks overview for %s '=> 'visió general subtasques per a %s ',
'Projects overview for %s '=> 'Panorama del projecte per a %s ',
...
'%d invitations were sent.'=> 'Es van enviar% invitacions d.',
'%d invitation was sent.'=> 'invitació %d ser enviat.',
...
'You are not allowed to change the assignee.'=> 'No se li permet canviar el cessionari.',
