...
return [
    ...
    '%s updated a comment on the task %s' => '%s یک نظر در وظیفه %s را به‌روزرسانی کرد',
    '%s commented the task %s' => '%s روی وظیفه %s نظر داد',
    ...
    'Reorder this column by id (ASC)' => 'مرتب‌سازی این ستون بر اساس شناسه (صعودی)',
    'Reorder this column by id (DESC)' => 'مرتب‌سازی این ستون بر اساس شناسه (نزولی)',
    ...
    'Automatically set the due date when the task is moved away from a specific column' => 'تاریخ سررسید به‌طور خودکار هنگام جابجایی وظیفه از یک ستون خاص تنظیم شود',
    'No other projects found.' => 'هیچ پروژه دیگری یافت نشد.',
    'Tasks copied successfully.' => 'وظایف با موفقیت کپی شدند.',
    'Unable to copy tasks.' => 'کپی کردن وظایف امکان‌پذیر نیست.',
    'Theme' => 'پوسته',
    'Theme:' => 'پوسته:',
    'Light theme' => 'پوسته روشن',
    'Dark theme' => 'پوسته تیره',
    'Automatic theme - Sync with system' => 'پوسته خودکار - هماهنگ با سیستم',
    'Application managers or more' => 'مدیران برنامه یا بالاتر',
    'Administrators' => 'مدیران',
    'Visibility:' => 'قابلیت مشاهده:',
    'Standard users' => 'کاربران عادی',
    'Visibility is required' => 'مشاهده‌پذیری لازم است',
    'The visibility should be an app role' => 'مشاهده‌پذیری باید یک نقش برنامه باشد',
    'Reply' => 'پاسخ',
    '%s wrote: ' => '%s نوشت:',
    'Number of visible tasks in this column and swimlane' => 'تعداد وظایف قابل مشاهده در این ستون و ردیف شناور',
    'Number of tasks in this swimlane' => 'تعداد وظایف در این ردیف شناور',
    'Unable to find another subtask in progress, you can close this window.' => 'زیر‌وظیفه دیگری در حال انجام یافت نشد، می‌توانید این پنجره را ببندید.',
    'This theme is invalid' => 'این پوسته نامعتبر است',
    'This role is invalid' => 'این نقش نامعتبر است',
    'This timezone is invalid' => 'این منطقه زمانی نامعتبر است',
    'This language is invalid' => 'این زبان نامعتبر است',
    'This URL is invalid' => 'این نشانی اینترنتی نامعتبر است',
    'Date format invalid' => 'فرمت تاریخ نامعتبر است',
    'Time format invalid' => 'فرمت زمان نامعتبر است',
    'Invalid Mail transport' => 'انتقال ایمیل نامعتبر است',
    'Color invalid' => 'رنگ نامعتبر است',
    'This value must be greater or equal to %d' => 'این مقدار باید بزرگتر یا مساوی %d باشد',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'افزودن BOM در ابتدای فایل (مورد نیاز برای Microsoft Excel)',
    'Just add these tag(s)' => 'فقط این برچسب(ها) را اضافه کنید',
    'Remove internal link(s)' => 'پیوند(های) داخلی را حذف کنید',
    'Import tasks from another project' => 'وارد کردن وظایف از پروژه‌ای دیگر',
    'Select the project to copy tasks from' => 'پروژه‌ای را که می‌خواهید وظایف از آن کپی شود انتخاب کنید',
    ...
    'Assign the task to its creator for specific columns if no assignee is set manually' => 'اگر مسئول به‌صورت دستی تعیین نشده باشد، برای ستون‌های مشخص، کار را به ایجادکنندهٔ آن واگذار کن',
    'Assign a task to the logged user on column change to specified column if no user is assigned' => 'اگر کاربری تعیین نشده باشد، هنگام تغییر ستون به ستون مشخص‌شده، کار را به کاربر واردشده اختصاص بده',
];
