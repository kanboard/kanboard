...
return array(
    ...
    'Assign the task to a specific user' => 'Priradiť úlohu zadanému používateľovi',
    'Assign the task to the person who does the action' => 'Priradiť úlohu osobe, ktorá vykonala akciu',
    ...
    'Position' => 'Pozícia',
    'Duplicate to another project' => 'Duplikovať do iného',
    ...
    'Assign automatically a color based on a category' => 'Automaticky priradiť farbu na základe kategórie',
    'Assign automatically a category based on a color' => 'Automaticky priradiť kategóriu na základe farby',
    ...
    'Assign a color when the task is moved to a specific column' => 'Priradiť farbu, keď je úloha presunutá do zadaného stĺpca',
    ...
    'Assign automatically a category based on a link' => 'Automaticky priradiť kategóriu na základe odkazu',
    ...
    'Assign automatically a color based on a priority' => 'Automaticky priradiť farbu na základe priority',
    ...
    'Comment removed on task #%d' => 'Odstránený komentár úlohy #%s',
    'Subtask removed on task #%d' => 'Odstránená podúloha úlohy #%s',
    ...
    'Assign a color when the task is moved to a specific swimlane' => 'Priradiť farbu, keď je úloha presunutá do zadanej dráhy',
    ...
    'Do you really want to remove this custom role: "%s"? All people assigned to this role will become project member.' => 'Naozaj chcete odstrániť vlastnú rolu: „%s”? Všetky osoby priradení k tejto role sa stanú členmi projektu.',
    ...
    '%d task' => '%d úloha',
    'Task ID' => 'ID úlohy',
    'Assign automatically a color when due date is expired' => 'Automaticky priradiť farbu, po vypršaní termínu splnenia',
    ...
    'minutes' => 'minúty',
    'seconds' => 'sekundy',
    'Assign automatically a color when preset start date is reached' => 'Automaticky priradiť farbu, keď nastane prednastavený dátum začiatku',
    ...
    'Assign a category when the task is moved to a specific swimlane' => 'Priradiť kategóriu, keď je úloha presunutá do zadanej dráhy',
