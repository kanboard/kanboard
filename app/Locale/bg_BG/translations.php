...
return [
    ...
    'PEN - Peruvian Sol' => 'PEN - Перуански сол',
    ...
    'Application managers or more' => 'Мениджъри на приложението или повече',
    'Administrators' => 'Администратори',
    'Visibility:' => 'Видимост:',
    'Standard users' => 'Стандартни потребители',
    'Visibility is required' => 'Видимостта е задължителна',
    'The visibility should be an app role' => 'Видимостта трябва да бъде роля на приложението',
    'Reply' => 'Отговор',
    '%s wrote: ' => '%s написа: ',
    'Number of visible tasks in this column and swimlane' => 'Брой видими задачи в тази колона и лента',
    'Number of tasks in this swimlane' => 'Брой задачи в тази лента',
    'Unable to find another subtask in progress, you can close this window.' => 'Не може да бъде намерена друга подзадача в процес, можете да затворите този прозорец.',
    'This theme is invalid' => 'Тази тема е невалидна',
    'This role is invalid' => 'Тази роля е невалидна',
    'This timezone is invalid' => 'Тази часова зона е невалидна',
    'This language is invalid' => 'Този език е невалиден',
    'This URL is invalid' => 'Този URL е невалиден',
    'Date format invalid' => 'Невалиден формат на дата',
    'Time format invalid' => 'Невалиден формат на час',
    'Invalid Mail transport' => 'Невалиден пощенски транспорт',
    'Color invalid' => 'Невалиден цвят',
    'This value must be greater or equal to %d' => 'Тази стойност трябва да бъде по-голяма или равна на %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Добавете BOM в началото на файла (необходимо за Microsoft Excel)',
    'Just add these tag(s)' => 'Добавете само тези етикети',
    'Remove internal link(s)' => 'Премахнете вътрешните връзки',
    'Import tasks from another project' => 'Импортирайте задачи от друг проект',
    'Select the project to copy tasks from' => 'Изберете проект, от който да копирате задачи',
