...
return array(
    ...
    'Ready' => 'Готово',
    'Backlog' => 'Списък на чакащите задачи' ,
    ...
    'Assigned to %s with an estimate of %s/%sh' => 'Зададено на %s с приблизителна оценка от %s/%sh',
    'Not assigned, estimate of %sh' => 'Не е зададено, оценка от %sh',
    ...
    'Change the assignee based on an external username' => 'Промяна на правоприемника въз основа на външно потребителско име',
    ...
    'Board settings' => 'Настройки на борда',
    ...
    'Example: "Bug, Feature Request, Improvement"' => 'Пример:„Грешка, заявка за функция, подобрение“',
    ...
    'New assignee: %s' => 'Нов правоприемник: %s',
    ...
    'Time spent changed: %sh' => 'Времето, прекарано в работа, се промени: %sh',
    'Time estimated changed: %sh' => 'Променено очаквано време: %sh',
    ...
    'Search by assignee: ' => 'Търсене по правоприемник:',
    ...
    'no category' => 'Няма категория',
    'Current assignee: %s' => 'Текущ правоприемник: %s',
    'not assigned' => 'Не е зададено',
    'Author:' => 'Автор',
    ...
    'Assignee changed on task #%d' => 'Възложител е променен при задача #%d',
    ...
    'Assignee Username' => 'Потребителско име на приобретателя',
    'Assignee Name' => 'Име на приобретателя',
    'Groups' => 'Групи',
    ...
    'Automatically set the due date on task creation' => 'Автоматично задаване на крайната дата при създаване на задача',
    ...
    'Unable to unlock the user.' => 'Не може да се отключи потребителят.',
    ...
    '%d task' => '%d задача',
    'Task ID' => 'ID на задачата',
    'Assign automatically a color when due date is expired' => 'Автоматично задаване на цвят, когато крайната дата е изтекла',
    ...
    'You are not allowed to change the assignee.' => 'Нямате право да променяте правоприемника.',
    'Task suppression is not permitted' => 'Потискането на задачи не е разрешено',
    'Changing assignee is not permitted' => 'Промяната на правоприемник не е разрешена',
    ...
    'minutes' => 'минути',
    'seconds' => 'секунди',
    'Assign automatically a color when preset start date is reached' => 'Автоматично задаване на цвят при достигане на предварително зададената начална дата',
    ...
    'Reorder this column by assignee and priority (ASC)' => 'Пренареждане на тази колона по правоприемник и приоритет (ВЪЗХОДЯЩ)',
    'Reorder this column by assignee and priority (DESC)' => 'Пренареждане на тази колона по правоприемник и приоритет (НИЗХОДЯЩ)',
    'Reorder this column by assignee (A-Z)' => 'Пренареждане на тази колона по правоприемник (A - Z)',
    'Reorder this column by assignee (Z-A)' => 'Пренареждане на тази колона по правоприемник (Я - А)',
    'Reorder this column by due date (ASC)' => 'Пренареждане на тази колона по крайна дата (ВЪЗХОДЯЩ)',
    'Reorder this column by due date (DESC)' => 'Пренареждане на тази колона по крайна дата (НИЗХОДЯЩ)',
    ...
    'Move the task to another column when the due date is less than a certain number of days' => 'Преместване на задачата в друга колона, когато крайният срок е по-малък от определен брой дни',
    ...
    'Automatically set the due date when the task is moved away from a specific column' => 'Автоматично задаване на крайната дата, когато задачата се премества от конкретна колона',
