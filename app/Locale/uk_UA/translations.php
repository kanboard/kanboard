...
return array(
    ...
    'This chart shows the average time spent into each column for the last %d tasks.' => 'Графік показує середній витрачений час в кожній колонці для останніх %d задач.',
