...
return [
    ...
    'PEN - Peruvian Sol' => 'PEN - Перуанський соль',
    ...
    'Application managers or more' => 'Менеджери додатків або більше',
    'Administrators' => 'Адміністратори',
    'Visibility:' => 'Видимість:',
    'Standard users' => 'Стандартні користувачі',
    'Visibility is required' => 'Видимість обов’язкова',
    'The visibility should be an app role' => 'Видимість має бути роллю додатка',
    'Reply' => 'Відповісти',
    '%s wrote: ' => '%s написав: ',
    'Number of visible tasks in this column and swimlane' => 'Кількість видимих ​​завдань у цьому стовпці та доріжці',
    'Number of tasks in this swimlane' => 'Кількість завдань у цій доріжці',
    'Unable to find another subtask in progress, you can close this window.' => 'Не вдається знайти інше підзавдання у процесі, можна закрити це вікно.',
    'This theme is invalid' => 'Ця тема недійсна',
    'This role is invalid' => 'Ця роль недійсна',
    'This timezone is invalid' => 'Цей часовий пояс недійсний',
    'This language is invalid' => 'Ця мова недійсна',
    'This URL is invalid' => 'Ця URL-адреса недійсна',
    'Date format invalid' => 'Недійсний формат дати',
    'Time format invalid' => 'Недійсний формат часу',
    'Invalid Mail transport' => 'Недійсний транспорт пошти',
    'Color invalid' => 'Колір недійсний',
    'This value must be greater or equal to %d' => 'Це значення має бути більше або дорівнювати %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Додайте BOM на початку файлу (обов’язково для Microsoft Excel)',
    'Just add these tag(s)' => 'Просто додайте ці теги',
    'Remove internal link(s)' => 'Видалити внутрішні посилання',
    'Import tasks from another project' => 'Імпортувати завдання з іншого проекту',
    'Select the project to copy tasks from' => 'Виберіть проект, з якого потрібно скопіювати завдання',
    ...
    'Assign the task to its creator for specific columns if no assignee is set manually' => 'Призначати завдання його автору для визначених колонок, якщо виконавець не встановлений вручну',
    'Assign a task to the logged user on column change to specified column if no user is assigned' => 'Призначати завдання поточному користувачу під час переміщення в указану колонку, якщо нікого не призначено',
];
