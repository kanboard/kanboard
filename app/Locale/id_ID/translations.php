...
return array(
    ...
    'Due date' => 'Batas tanggal terakhir',
    'Others formats accepted: %s and %s' => 'Format lain yang didukung: %s dan %s',
    ...
    'New remote user' => 'Pengguna jauh baru',
    'New local user' => 'Pengguna lokal baru',
    ...
    'Project owner' => 'Pemilik proyek',
    'Those dates are useful for the project Gantt chart.' => 'Tanggal tersebut berguna untuk proyek grafik Gantt',
    ...
    'View uploaded files' => 'Lihat berkas yang diunggah',
    'The maximum allowed file size is %sB.' => 'Maksimum ukuran berkas yang diiziinkan adalah %sB.',
    'Choose files again' => 'Pilih berkas kembali',
    ...
    'Subtasks export' => 'Ekspor sub-tugas',
    'Tasks exportation' => 'Eksportasi tugas-tugas',
