...
return array(
    ...
    'Allow everybody to access to this project' => 'A projekt elérés mindenkinek engedélyezett',
    ...
    'Help on Gitlab webhooks' => 'Gitlab webhooks segítség',
    ...
    // 'Add a comment logging moving the task between columns' => 'Ajouter un commentaire de log lorsqu\'une tÃ¢che est dÃ©placÃ©e dans une autre colonne',
    'Moved to column %s' => '%s oszlopba áthelyezve',
    'Change description' => 'Leírás szerkesztés',
    'User dashboard' => 'Felhasználó vezérlőpult',
    'Allow only one subtask in progress at the same time for a user' => 'Egyszerre csak egy folyamatban levő részfeladat engedélyezés a felhasználóknak',
    'Edit column "%s"' => 'Oszlop szerkesztés: %s',
    'Enable time tracking for subtasks' => 'Idő követés engedélyezése az részfeladatokhoz',
    ...
    'Show/hide subtasks' => 'Al-feadatok megjelenítése/elrejtése',
    ...
    'User calendar' => 'Naptár használata',
    'Bitbucket commit received' => 'Bitbucket commit érkezett',
    'Bitbucket webhooks' => 'Bitbucket webhooks',
    'Help on Bitbucket webhooks' => 'Bitbucket webhooks segítség',
    'Start' => 'Kezdet',
    'End' => 'Vég',
    ...
    // 'Do you really want to remove this link with task #%d?' => 'Voulez-vous vraiment supprimer ce lien avec la tÃ¢che nÂ°%s ?',
    ...
    'relates to' => 'hozzáa tartozik: ',
    'blocks' => 'blokkok',
    'is blocked by' => 'letitoltta:',
    'duplicates' => 'másolat',
    'is duplicated by' => 'másolta:',
    'is a child of' => 'szülője:',
    'is a parent of' => 'gyermeke:',
    'targets milestone' => 'cél mérföldkő',
    'is a milestone of' => 'hozzá tartozó mérföldkő:',
    'fixes' => 'javítás',
    ...
    'Open board switcher' => 'Tábla választó megnyitása',
);
