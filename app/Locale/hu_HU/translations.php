...
return [
    ...
    'PEN - Peruvian Sol' => 'PEN - Perui sol',
    ...
    'Reply' => 'Válasz',
    '%s wrote: ' => '%s írta: ',
    'Number of visible tasks in this column and swimlane' => 'Látható feladatok száma ebben az oszlopban és sávban',
    'Number of tasks in this swimlane' => 'Feladatok száma ebben a sávban',
    'Unable to find another subtask in progress, you can close this window.' => 'Nem található másik folyamatban lévő alerőforrás, bezárhatja ezt az ablakot.',
    'This theme is invalid' => 'Ez a téma érvénytelen',
    'This role is invalid' => 'Ez a szerepkör érvénytelen',
    'This timezone is invalid' => 'Ez az időzóna érvénytelen',
    'This language is invalid' => 'Ez a nyelv érvénytelen',
    'This URL is invalid' => 'Ez az URL érvénytelen',
    'Date format invalid' => 'Érvénytelen dátumformátum',
    'Time format invalid' => 'Érvénytelen időformátum',
    'Invalid Mail transport' => 'Érvénytelen levélátvitel',
    'Color invalid' => 'Érvénytelen szín',
    'This value must be greater or equal to %d' => 'Ennek az értéknek nagyobbnak vagy egyenlőnek kell lennie, mint %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'BOM hozzáadása a fájl elejéhez (kötelező a Microsoft Excel számára)',
    'Just add these tag(s)' => 'Csak adja hozzá ezeket a címkéket',
    'Remove internal link(s)' => 'Belső hivatkozás(ok) eltávolítása',
    'Import tasks from another project' => 'Feladatok importálása másik projektből',
    'Select the project to copy tasks from' => 'Válassza ki a projektet, ahonnan a feladatokat másolni szeretné',
