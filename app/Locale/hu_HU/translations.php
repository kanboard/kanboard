...
return array(
    ...
    'Close a task when there is no activity in an specific column' => 'Zárd le a feladatot, ha az adott oszlopban nincs tevékenység',
    ...
    '%d task' => '%d feladat',
    'Task ID' => 'Feladat ID',
    'Assign automatically a color when due date is expired' => 'Szín automatikus hozzárendelése, ha lejárt a határidő',
