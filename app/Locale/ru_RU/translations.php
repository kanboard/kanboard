...
return array(
    ...
    'This chart shows the average time spent into each column for the last %d tasks.' => 'Эта диаграмма показывает среднее время, проведенное в каждой колонке для последних %d задач.',
