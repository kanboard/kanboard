...
return [
    ...
    'Expand vertically' => 'Развернуть по вертикали',
    'MXN - Mexican Peso' => 'MXN - Мексиканское песо',
    'Estimated vs actual time per column' => 'Оценочное и фактическое время по колонке',
    ...
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'Загруженный вами файл не является допустимым изображением! (Разрешены только *.gif, *.jpg, *.jpeg и *.png!)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Автоматически устанавливать срок, когда задача перемещается из определенной колонки',
    'No other projects found.' => 'Другие проекты не найдены.',
    ...
    'Automatic theme - Sync with system' => 'Автоматическая тема — синхронизировать с системой',
    'Application managers or more' => 'Менеджеры приложения или выше',
    'Administrators' => 'Администраторы',
    'Visibility:' => 'Видимость:',
    'Standard users' => 'Обычные пользователи',
    'Visibility is required' => 'Требуется видимость',
    'The visibility should be an app role' => 'Видимость должна быть ролью приложения',
    'Reply' => 'Ответить',
    '%s wrote: ' => '%s написал: ',
    'Number of visible tasks in this column and swimlane' => 'Количество видимых задач в этой колонке и дорожке',
    'Number of tasks in this swimlane' => 'Количество задач в этой дорожке',
    'Unable to find another subtask in progress, you can close this window.' => 'Не удалось найти другую подзадачу в процессе, вы можете закрыть это окно.',
    'This theme is invalid' => 'Эта тема недействительна',
    'This role is invalid' => 'Эта роль недействительна',
    'This timezone is invalid' => 'Этот часовой пояс недействителен',
    'This language is invalid' => 'Этот язык недействителен',
    'This URL is invalid' => 'Этот URL недействителен',
    'Date format invalid' => 'Неверный формат даты',
    'Time format invalid' => 'Неверный формат времени',
    'Invalid Mail transport' => 'Недопустимый почтовый транспорт',
    'Color invalid' => 'Недопустимый цвет',
    'This value must be greater or equal to %d' => 'Это значение должно быть больше или равно %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Добавьте BOM в начало файла (требуется для Microsoft Excel)',
    'Just add these tag(s)' => 'Добавьте только эти теги',
    'Remove internal link(s)' => 'Удалить внутренние ссылки',
    'Import tasks from another project' => 'Импортировать задачи из другого проекта',
    'Select the project to copy tasks from' => 'Выберите проект, из которого нужно скопировать задачи',
