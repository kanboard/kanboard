...
return array(
    ...
    'Color' => 'Boja',
    'Assignee' => 'Izvršilac',
    'Create another task' => 'Otvori formu za novi zadatak',
    ...
    'Add a child task' => 'Dodaj dijete zadatak',
    ...
    'Enable/disable two factor authentication' => 'Omogući/onemogući faktor-dva autentifikaciju',
    'This QR code contains the key URI: ' => 'Ovaj QR kod sadržava ključni URL: ',
    'Save the secret key in your TOTP software (by example Google Authenticator or FreeOTP).' => 'Sačuvaj tajni klju u svom TOTP softveru (npr. Google Authenticator or FreeOTP)',
    ...
    '%s attached a new file to the task %s' => '%s je dodao novi faj u zadatak %s',
    ...
    'Assignee Username' => 'Dodijeli po korisničkom imenu',
    'Assignee Name' => 'Dodijeli po imenu',
    'Groups' => 'Grupe',
    'Members of %s' => 'Članovi %s',
    'New group' => 'Nova grupa',
    'Group created successfully.' => 'Grupa je uspješno kreirana.',
    ...
    'Add group member to "%s"' => 'Dodan član grupe u "%s"',
    'Group member added successfully.' => 'Član grupe uspješno dodan.',
    'Unable to add group member.' => 'Nemoguće dodati člana grupe.',
    'Remove user from group "%s"' => 'Ukloni korisnika iz grup "%s"',
    ...
    'Project Permissions' => 'Privilegije na projektu',
    'Manager' => 'Menadžer',
    'Project Manager' => 'Menadžer projekta',
    'Project Member' => 'Član projekta',
    'Project Viewer' => 'Nadzornik projekta',
    'Gitlab issue reopened' => 'Gitlab: problem ponovo otvoren',
    'Your account is locked for %d minutes' => 'Vaš korisnički račun je zaključan na %d minuta',
    ...
    'There is no group.' => 'Ovdje nema grupe.',
    ...
    'There is no user in this group.' => 'Nema korisnika u ovoj grupi.',
    'Remove this user' => 'Ukloni ovog korisnika',
    'Permissions' => 'Privilegije',
    'Allowed Users' => 'Korisnička odobrenja',
    'No user have been allowed specifically.' => 'Nema korisnika s posebnim odobrenjima.',
    'Role' => 'Uloga',
    'Enter user name...' => 'Unesi korisničko ime...',
    'Allowed Groups' => 'Grupna odobrenja',
    'No group have been allowed specifically.' => 'Nema grupe s posebnim odobrenjima',
    'Group' => 'Grupa',
