...
return [
    ...
    'CNY - Chinese Yuan' => 'CNY - Kineski juan',
    ...
    'ARS - Argentine Peso' => 'ARS - Argentinski pezo',
    'COP - Colombian Peso' => 'COP - Kolumbijski pezo',
    '%d groups' => '%d grupa',
    '%d group' => '%d grupa',
    'Group ID' => 'ID grupe',
    ...
    '%d users' => '%d korisnika',
    '%d user' => '%d korisnik',
    'Hide subtasks' => 'Sakrij pod-zadatke',
    'Show subtasks' => 'Prikaži pod-zadatke',
    'Authentication Parameters' => 'Parametri autentifikacije',
    'API Access' => 'API pristup',
    'No users found.' => 'Nema pronađenih korisnika.',
    'User ID' => 'ID korisnika',
    'Notifications are activated' => 'Obavještenja su aktivirana',
    'Notifications are disabled' => 'Obavještenja su onemogućena',
    'User disabled' => 'Korisnik onemogućen',
    '%d notifications' => '%d obavještenja',
    '%d notification' => '%d obavještenje',
    'There is no external integration installed.' => 'Nema instaliranih vanjskih integracija.',
    'You are not allowed to update tasks assigned to someone else.' => 'Nemaš dozvolu za ažuriranje zadataka dodijeljenih drugima.',
    'You are not allowed to change the assignee.' => 'Nemaš dozvolu za promjenu izvršioca.',
    'Task suppression is not permitted' => 'Brisanje zadatka nije dozvoljeno',
    'Changing assignee is not permitted' => 'Promjena izvršioca nije dozvoljena',
    'Update only assigned tasks is permitted' => 'Ažuriranje samo dodijeljenih zadataka je dozvoljeno',
    'Only for tasks assigned to the current user' => 'Samo za zadatke dodijeljene trenutnom korisniku',
    'My projects' => 'Moji projekti',
    'You are not a member of any project.' => 'Nisi član ni jednog projekta.',
    'My subtasks' => 'Moji pod-zadaci',
    '%d subtasks' => '%d pod-zadataka',
    '%d subtask' => '%d pod-zadatak',
    'Only moving task between those columns is permitted for tasks assigned to the current user' => 'Pomijeranje zadataka između ovih kolona je dozvoljeno samo za zadatke dodijeljene trenutnom korisniku',
    '[DUPLICATE]' => '[DUPLIKAT]',
    'DKK - Danish Krona' => 'DKK - Danska kruna',
    'Remove user from group' => 'Ukloni korisnika iz grupe',
    'Assign the task to its creator' => 'Dodijeli zadatak njegovom kreatoru',
    'This task was sent by email to "%s" with subject "%s".' => 'Ovaj zadatak je poslan email-om "%s" sa predmetom "%s".',
    'Predefined Email Subjects' => 'Predefinisani predmeti email-a',
    'Write one subject by line.' => 'Napiši jedan predmet po liniji.',
    'Create another link' => 'Kreiraj drugu vezu',
    'BRL - Brazilian Real' => 'BRL - Brazilski real',
    'Add a new Kanboard task' => 'Dodaj novi Kanboard zadatak',
    'Subtask not started' => 'Pod-zadatak nije započet',
    'Subtask currently in progress' => 'Pod-zadatak trenutno u toku',
    'Subtask completed' => 'Pod-zadatak završen',
    'Subtask added successfully.' => 'Pod-zadatak uspješno dodan.',
    '%d subtasks added successfully.' => '%d pod-zadataka uspješno dodano.',
    'Enter one subtask by line.' => 'Unesi jedan pod-zadatak po liniji.',
    'Predefined Contents' => 'Predefinisani sadržaji',
    'Predefined contents' => 'Predefinisani sadržaji',
    'Predefined Task Description' => 'Predefinisani opis zadatka',
    'Do you really want to remove this template? "%s"' => 'Da li zaista želiš ukloniti ovaj šablon? "%s"',
    'Add predefined task description' => 'Dodaj predefinisani opis zadatka',
    'Predefined Task Descriptions' => 'Predefinisani opisi zadataka',
    'Template created successfully.' => 'Šablon uspješno kreiran.',
    'Unable to create this template.' => 'Nemoguće kreirati ovaj šablon.',
    'Template updated successfully.' => 'Šablon uspješno ažuriran.',
    'Unable to update this template.' => 'Nemoguće ažurirati ovaj šablon.',
    'Template removed successfully.' => 'Šablon uspješno uklonjen.',
    'Unable to remove this template.' => 'Nemoguće ukloniti ovaj šablon.',
    'Template for the task description' => 'Šablon za opis zadatka',
    'The start date is greater than the end date' => 'Početni datum je veći od krajnjeg datuma',
    'Tags must be separated by a comma' => 'Oznake moraju biti odvojene zarezom',
    'Only the task title is required' => 'Samo je naslov zadatka obavezan',
    'Creator Username' => 'Korisničko ime kreatora',
    'Color Name' => 'Naziv boje',
    'Column Name' => 'Naziv kolone',
    'Swimlane Name' => 'Naziv swimlane trake',
    'Time Estimated' => 'Procijenjeno vrijeme',
    'Time Spent' => 'Utrošeno vrijeme',
    'External Link' => 'Vanjska veza',
    'This feature enables the iCal feed, RSS feed and the public board view.' => 'Ova funkcionalnost omogućava iCal feed, RSS feed i javni pregled ploče.',
    'Stop the timer of all subtasks when moving a task to another column' => 'Zaustavi tajmer svih pod-zadataka kada se zadatak premjesti u drugu kolonu',
    'Subtask Title' => 'Naslov pod-zadatka',
    'Add a subtask and activate the timer when moving a task to another column' => 'Dodaj pod-zadatak i aktiviraj tajmer kada se zadatak premjesti u drugu kolonu',
    'days' => 'dana',
    'minutes' => 'minuta',
    'seconds' => 'sekundi',
    'Assign automatically a color when preset start date is reached' => 'Automatski dodijeli boju kada se dostigne unaprijed postavljeni početni datum',
    'Move the task to another column once a predefined start date is reached' => 'Premjesti zadatak u drugu kolonu kada se dostigne unaprijed postavljeni početni datum',
    'This task is now linked to the task %s with the relation "%s"' => 'Ovaj zadatak je sada povezan sa zadatkom %s sa relacijom "%s"',
    'The link with the relation "%s" to the task %s has been removed' => 'Veza sa relacijom "%s" prema zadatku %s je uklonjena',
    'Custom Filter:' => 'Prilagođeni filter:',
    'Unable to find this group.' => 'Nemoguće pronaći ovu grupu.',
    '%s moved the task #%d to the column "%s"' => '%s je premjestio zadatak #%d u kolonu "%s"',
    '%s moved the task #%d to the position %d in the column "%s"' => '%s je premjestio zadatak #%d na poziciju %d u koloni "%s"',
    '%s moved the task #%d to the swimlane "%s"' => '%s je premjestio zadatak #%d u swimlane traku "%s"',
    '%sh spent' => '%sh utrošeno',
    '%sh estimated' => '%sh procijenjeno',
    'Select All' => 'Označi sve',
    'Unselect All' => 'Poništi sve',
    'Apply action' => 'Primijeni akciju',
    'Move selected tasks to another column or swimlane' => 'Premjesti odabrane zadatke u drugu kolonu ili swimlane traku',
    'Edit tasks in bulk' => 'Uredi zadatke u rinfuzi',
    'Choose the properties that you would like to change for the selected tasks.' => 'Izaberi svojstva koja želiš promijeniti za odabrane zadatke.',
    'Configure this project' => 'Konfiguriši ovaj projekat',
    'Start now' => 'Počni sada',
    '%s removed a file from the task #%d' => '%s je uklonio datoteku sa zadatka #%d',
    'Attachment removed from task #%d: %s' => 'Prilog uklonjen sa zadatka #%d: %s',
    'No color' => 'Bez boje',
    'Attachment removed "%s"' => 'Prilog uklonjen "%s"',
    '%s removed a file from the task %s' => '%s je uklonio datoteku sa zadatka %s',
    'Move the task to another swimlane when assigned to a user' => 'Premjesti zadatak u drugu swimlane traku kada je dodijeljen korisniku',
    'Destination swimlane' => 'Odredišna swimlane traka',
    'Assign a category when the task is moved to a specific swimlane' => 'Dodijeli kategoriju kada je zadatak premješten u određenu swimlane traku',
    'Move the task to another swimlane when the category is changed' => 'Premjesti zadatak u drugu swimlane traku kada je kategorija promijenjena',
    'Reorder this column by priority (ASC)' => 'Presortiraj ovu kolonu po prioritetu (ASC)',
    'Reorder this column by priority (DESC)' => 'Presortiraj ovu kolonu po prioritetu (DESC)',
    'Reorder this column by assignee and priority (ASC)' => 'Presortiraj ovu kolonu po izvršiocu i prioritetu (ASC)',
    'Reorder this column by assignee and priority (DESC)' => 'Presortiraj ovu kolonu po izvršiocu i prioritetu (DESC)',
    'Reorder this column by assignee (A-Z)' => 'Presortiraj ovu kolonu po izvršiocu (A-Z)',
    'Reorder this column by assignee (Z-A)' => 'Presortiraj ovu kolonu po izvršiocu (Z-A)',
    'Reorder this column by due date (ASC)' => 'Presortiraj ovu kolonu po datumu završetka (ASC)',
    'Reorder this column by due date (DESC)' => 'Presortiraj ovu kolonu po datumu završetka (DESC)',
    'Reorder this column by id (ASC)' => 'Presortiraj ovu kolonu po ID-u (ASC)',
    'Reorder this column by id (DESC)' => 'Presortiraj ovu kolonu po ID-u (DESC)',
    '%s moved the task #%d "%s" to the project "%s"' => '%s je premjestio zadatak #%d "%s" u projekat "%s"',
    'Task #%d "%s" has been moved to the project "%s"' => 'Zadatak #%d "%s" je premješten u projekat "%s"',
    'Move the task to another column when the due date is less than a certain number of days' => 'Premjesti zadatak u drugu kolonu kada je datum završetka manji od određenog broja dana',
    'Automatically update the start date when the task is moved away from a specific column' => 'Automatski ažuriraj početni datum kada je zadatak premješten iz određene kolone',
    'HTTP Client:' => 'HTTP klijent:',
    'Assigned' => 'Dodijeljen',
    'Task limits apply to each swimlane individually' => 'Ograničenja zadataka se primjenjuju na svaku swimlane traku pojedinačno',
    'Column task limits apply to each swimlane individually' => 'Ograničenja zadataka u koloni se primjenjuju na svaku swimlane traku pojedinačno',
    'Column task limits are applied to each swimlane individually' => 'Ograničenja zadataka u koloni se primjenjuju na svaku swimlane traku pojedinačno',
    'Column task limits are applied across swimlanes' => 'Ograničenja zadataka u koloni se primjenjuju na sve swimlane trake',
    'Task limit: ' => 'Ograničenje zadatka: ',
    'Change to global tag' => 'Promijeni u globalnu oznaku',
    'Do you really want to make the tag "%s" global?' => 'Da li zaista želiš učiniti oznaku "%s" globalnom?',
    'Enable global tags for this project' => 'Omogući globalne oznake za ovaj projekat',
    'Group membership(s):' => 'Članstvo u grupi:',
    '%s is a member of the following group(s): %s' => '%s je član sljedećih grupa: %s',
    '%d/%d group(s) shown' => '%d/%d grupa prikazano',
    'Subtask creation or modification' => 'Kreiranje ili izmjena pod-zadatka',
    'Assign the task to a specific user when the task is moved to a specific swimlane' => 'Dodijeli zadatak određenom korisniku kada je zadatak premješten u određenu swimlane traku',
    'Comment' => 'Komentar',
    'Collapse vertically' => 'Skupi vertikalno',
    'Expand vertically' => 'Proširi vertikalno',
    'MXN - Mexican Peso' => 'MXN - Meksički pezo',
    'Estimated vs actual time per column' => 'Procijenjeno naspram stvarnog vremena po koloni',
    'HUF - Hungarian Forint' => 'HUF - Mađarski forint',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => 'Morate odabrati datoteku za otpremanje kao svoj avatar!',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'Datoteka koju ste otpremili nije važeća slika! (Dozvoljeni su samo *.gif, *.jpg, *.jpeg i *.png!)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Automatski postavi rok kada se zadatak premjesti iz određene kolone',
    'No other projects found.' => 'Nema pronađenih drugih projekata.',
    'Tasks copied successfully.' => 'Zadaci su uspješno kopirani.',
    ...
    'The visibility should be an app role' => 'Vidljivost treba biti uloga aplikacije',
    'Reply' => 'Odgovori',
    '%s wrote: ' => '%s je napisao: ',
    ...
    'Unable to find another subtask in progress, you can close this window.' => 'Nije moguće pronaći drugu podzadatak u toku, možete zatvoriti ovaj prozor.',
    'This theme is invalid' => 'Ova tema nije važeća',
    'This role is invalid' => 'Ova uloga nije važeća',
    'This timezone is invalid' => 'Ova vremenska zona nije važeća',
    'This language is invalid' => 'Ovaj jezik nije važeći',
    'This URL is invalid' => 'Ovaj URL nije važeći',
    'Date format invalid' => 'Nevažeći format datuma',
    'Time format invalid' => 'Nevažeći format vremena',
    'Invalid Mail transport' => 'Nevažeći mail transport',
    'Color invalid' => 'Nevažeća boja',
    'This value must be greater or equal to %d' => 'Ova vrijednost mora biti veća ili jednaka %d',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'Dodajte BOM na početak datoteke (potrebno za Microsoft Excel)',
    'Just add these tag(s)' => 'Dodajte samo ove oznake',
    'Remove internal link(s)' => 'Uklonite interne veze',
    ...
    'Enable notifications by default for all new users' => 'Omogući obavještenja po difoltu za sve nove korisnike',
    'Assign the task to its creator for specific columns if no assignee is set manually' => 'Dodijeli zadatak njegovom kreatoru za određene kolone ako izvršilac nije ručno postavljen',
    'Assign a task to the logged user on column change to specified column if no user is assigned' => 'Dodijeli zadatak prijavljenom korisniku pri promjeni kolone na odabranu kolonu ako niko nije dodijeljen',
];
