...
return [
    ...
    'Reorder this column by id (ASC)' => 'この列をIDで並べ替え (昇順)',
    'Reorder this column by id (DESC)' => 'この列をIDで並べ替え (降順)',
    ...
    'Estimated vs actual time per column' => '列ごとの見積もり時間 vs 実際にかかった時間',
    'HUF - Hungarian Forint' => 'HUF - ハンガリー・フォリント',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => 'アバターとしてアップロードするファイルを選択してください！',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'アップロードされたファイルは有効な画像ではありません！ (許可されているのは *.gif, *.jpg, *.jpeg, *.png のみです)',
    'Automatically set the due date when the task is moved away from a specific column' => '特定の列からタスクが移動されたときに期限を自動的に設定する',
    'No other projects found.' => '他のプロジェクトは見つかりませんでした。',
    'Tasks copied successfully.' => 'タスクが正常にコピーされました。',
    'Unable to copy tasks.' => 'タスクをコピーできません。',
    'Theme' => 'テーマ',
    'Theme:' => 'テーマ:',
    'Light theme' => 'ライトテーマ',
    'Dark theme' => 'ダークテーマ',
    'Automatic theme - Sync with system' => '自動テーマ - システムと同期',
    'Application managers or more' => 'アプリケーションマネージャー以上',
    'Administrators' => '管理者',
    'Visibility:' => '可視性:',
    'Standard users' => '標準ユーザー',
    'Visibility is required' => '可視性は必須です',
    'The visibility should be an app role' => '可視性はアプリの役割である必要があります',
    'Reply' => '返信',
    '%s wrote: ' => '%s が書きました:',
    'Number of visible tasks in this column and swimlane' => 'この列とスイムレーンで表示されているタスクの数',
    'Number of tasks in this swimlane' => 'このスイムレーンにあるタスクの数',
    'Unable to find another subtask in progress, you can close this window.' => '他の進行中のサブタスクが見つかりません。このウィンドウを閉じることができます。',
    'This theme is invalid' => 'このテーマは無効です',
    'This role is invalid' => 'この役割は無効です',
    'This timezone is invalid' => 'このタイムゾーンは無効です',
    'This language is invalid' => 'この言語は無効です',
    'This URL is invalid' => 'このURLは無効です',
    'Date format invalid' => '日付形式が無効です',
    'Time format invalid' => '時刻形式が無効です',
    'Invalid Mail transport' => '無効なメール転送',
    'Color invalid' => '色が無効です',
    'This value must be greater or equal to %d' => 'この値は %d 以上である必要があります',
    'Add a BOM at the beginning of the file (required for Microsoft Excel)' => 'ファイルの先頭にBOMを追加する（Microsoft Excelに必要）',
    'Just add these tag(s)' => 'これらのタグを追加するだけ',
    'Remove internal link(s)' => '内部リンクを削除',
    'Import tasks from another project' => '他のプロジェクトからタスクをインポートする',
    'Select the project to copy tasks from' => 'タスクをコピーするプロジェクトを選択してください',
    ...
    'Assign the task to its creator for specific columns if no assignee is set manually' => '担当者が手動で設定されていない場合、指定したカラムではタスクを作成者に割り当てる',
    'Assign a task to the logged user on column change to specified column if no user is assigned' => '担当者がいない場合、カラム変更で指定のカラムに移動したときにタスクをログインユーザーに割り当てる',
];
