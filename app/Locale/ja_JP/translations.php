...
return array(
    ...
    'Stop the timer of all subtasks when moving a task to another column' => 'タスクを別のコラムに移動したときに、全てのサブタスクのタイマーを停止する',
    'Subtask Title' => 'サブタスクのタイトル',
    'Add a subtask and activate the timer when moving a task to another column' => 'サブタスクを追加し、タスクを別のコラムに移動したときにタイマーを有効化する',
    'days' => '日',
    'minutes' => '分',
    'seconds' => '秒',
    ...
    'Move selected tasks to another column' => '選択したタスクを別のコラムに移動',
    // 'Edit tasks in bulk' => '',
    ...
    'Attachment removed from task #%d: %s' => 'タスク #%d への添付ファイルは %s により削除されました',
    // 'No color' => '',
