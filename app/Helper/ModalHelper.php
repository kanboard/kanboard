...
class ModalHelper extends Base
{
    ...
    {
        $html = '<em class="fa fa-'.$icon.' fa-fw js-modal-large" aria-hidden="true"></em>';
    ...
    {
        $html = '<em class="fa fa-'.$icon.' fa-fw js-modal-large" aria-hidden="true"></em>'.$label;
    ...
    {
        $html = '<em class="fa fa-'.$icon.' fa-fw js-modal-medium" aria-hidden="true"></em>'.$label;
    ...
    {
        $html = '<em class="fa fa-'.$icon.' fa-fw js-modal-small" aria-hidden="true"></em>'.$label;
    ...
    {
        $html = '<em class="fa fa-'.$icon.' fa-fw js-modal-medium" aria-hidden="true"></em>';
    ...
    {
        $html = '<em class="fa fa-'.$icon.' fa-fw js-modal-confirm" aria-hidden="true"></em>'.$label;
    ...
    {
        $html = '<em class="fa fa-'.$icon.' fa-fw js-modal-replace" aria-hidden="true"></em>'.$label;
